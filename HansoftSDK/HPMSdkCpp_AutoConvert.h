...
template <>
class TCCppConvert<HPMBinaryBuffer, NInternal_C::HPMBinaryBuffer>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMBinaryBuffer const &_From, NInternal_C::HPMBinaryBuffer &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		{
...
template <>
class TCCppConvertReverse<NInternal_C::HPMBinaryBuffer, HPMBinaryBuffer>
{
public:
	static void Convert(NInternal_C::HPMBinaryBuffer const &_From, HPMBinaryBuffer &_To, CCppConvertContext &_Context)
	{
		{
...
public:
	...
	public:
		...
		std::vector<NInternal_C::HPMColumn> m_ColumnsOrdering;
	...
	static void Convert(HPMReport const &_From, NInternal_C::HPMReport &_To, CCppConvertContext &_Context)
	{
		...
		{
			size_t nMembers = _From.m_ColumnsOrdering.size();
			pLocal->m_ColumnsOrdering.resize(nMembers);
			_To.m_nColumnsOrdering = (unsigned int)nMembers;
			if (nMembers)
				_To.m_pColumnsOrdering = &(*pLocal->m_ColumnsOrdering.begin());
			else
				_To.m_pColumnsOrdering = 0;
			for (size_t i = 0; i < nMembers; ++i)
			{
				CppConvert(_From.m_ColumnsOrdering[i], pLocal->m_ColumnsOrdering[i], _Context);
			}
		}
...
public:
	static void Convert(NInternal_C::HPMReport const &_From, HPMReport &_To, CCppConvertContext &_Context)
	{
		...
		{
			size_t nMembers = _From.m_nColumnsOrdering;
			_To.m_ColumnsOrdering.resize(nMembers);
			for (size_t i = 0; i < nMembers; ++i)
			{
				CppConvertReverse(_From.m_pColumnsOrdering[i], _To.m_ColumnsOrdering[i], _Context);
			}
		}
...
template <>
class TCCppConvert<HPMDashboardPageLayoutChart, NInternal_C::HPMDashboardPageLayoutChart>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMDashboardPageLayoutChart const &_From, NInternal_C::HPMDashboardPageLayoutChart &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_ChartID, _To.m_ChartID, _Context);
	}
};
template <>
class TCCppConvertReverse<NInternal_C::HPMDashboardPageLayoutChart, HPMDashboardPageLayoutChart>
{
public:
	static void Convert(NInternal_C::HPMDashboardPageLayoutChart const &_From, HPMDashboardPageLayoutChart &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_ChartID, _To.m_ChartID, _Context);
	}
};

template <>
class TCCppConvert<HPMDashboardPageLayoutColumn, NInternal_C::HPMDashboardPageLayoutColumn>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	public:
		std::vector<NInternal_C::HPMDashboardPageLayoutChart> m_Charts;
	};
	
	static void Convert(HPMDashboardPageLayoutColumn const &_From, NInternal_C::HPMDashboardPageLayoutColumn &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		{
			size_t nMembers = _From.m_Charts.size();
			pLocal->m_Charts.resize(nMembers);
			_To.m_nCharts = (unsigned int)nMembers;
			if (nMembers)
				_To.m_pCharts = &(*pLocal->m_Charts.begin());
			else
				_To.m_pCharts = 0;
			for (size_t i = 0; i < nMembers; ++i)
			{
				CppConvert(_From.m_Charts[i], pLocal->m_Charts[i], _Context);
			}
		}
	}
};
template <>
class TCCppConvertReverse<NInternal_C::HPMDashboardPageLayoutColumn, HPMDashboardPageLayoutColumn>
{
public:
	static void Convert(NInternal_C::HPMDashboardPageLayoutColumn const &_From, HPMDashboardPageLayoutColumn &_To, CCppConvertContext &_Context)
	{
		{
			size_t nMembers = _From.m_nCharts;
			_To.m_Charts.resize(nMembers);
			for (size_t i = 0; i < nMembers; ++i)
			{
				CppConvertReverse(_From.m_pCharts[i], _To.m_Charts[i], _Context);
			}
		}
	}
};
...
template <>
class TCCppConvert<HPMDashboardPageLayout, NInternal_C::HPMDashboardPageLayout>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	public:
		std::vector<NInternal_C::HPMDashboardPageLayoutColumn> m_Columns;
	};
	
	static void Convert(HPMDashboardPageLayout const &_From, NInternal_C::HPMDashboardPageLayout &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_Type, _To.m_Type, _Context);
...
template <>
class TCCppConvertReverse<NInternal_C::HPMDashboardPageLayout, HPMDashboardPageLayout>
{
public:
	static void Convert(NInternal_C::HPMDashboardPageLayout const &_From, HPMDashboardPageLayout &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_Type, _To.m_Type, _Context);
		{
...
template <>
class TCCppConvert<HPMDashboardChartResultSetInfo, NInternal_C::HPMDashboardChartResultSetInfo>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMDashboardChartResultSetInfo const &_From, NInternal_C::HPMDashboardChartResultSetInfo &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_ForecastingStart, _To.m_ForecastingStart, _Context);
	}
};
template <>
class TCCppConvertReverse<NInternal_C::HPMDashboardChartResultSetInfo, HPMDashboardChartResultSetInfo>
{
public:
	static void Convert(NInternal_C::HPMDashboardChartResultSetInfo const &_From, HPMDashboardChartResultSetInfo &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_ForecastingStart, _To.m_ForecastingStart, _Context);
	}
};

template <>
class TCCppConvert<HPMDashboardChartBounds, NInternal_C::HPMDashboardChartBounds>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMDashboardChartBounds const &_From, NInternal_C::HPMDashboardChartBounds &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_Lower, _To.m_Lower, _Context);
		CppConvert(_From.m_Upper, _To.m_Upper, _Context);
	}
};
template <>
class TCCppConvertReverse<NInternal_C::HPMDashboardChartBounds, HPMDashboardChartBounds>
{
public:
	static void Convert(NInternal_C::HPMDashboardChartBounds const &_From, HPMDashboardChartBounds &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_Lower, _To.m_Lower, _Context);
		CppConvertReverse(_From.m_Upper, _To.m_Upper, _Context);
	}
};

template <>
class TCCppConvert<HPMDashboardChartIdealBurndown, NInternal_C::HPMDashboardChartIdealBurndown>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMDashboardChartIdealBurndown const &_From, NInternal_C::HPMDashboardChartIdealBurndown &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_Flags, _To.m_Flags, _Context);
		CppConvert(_From.m_StartValue, _To.m_StartValue, _Context);
		CppConvert(_From.m_StartUnit, _To.m_StartUnit, _Context);
	}
};
template <>
class TCCppConvertReverse<NInternal_C::HPMDashboardChartIdealBurndown, HPMDashboardChartIdealBurndown>
{
public:
	static void Convert(NInternal_C::HPMDashboardChartIdealBurndown const &_From, HPMDashboardChartIdealBurndown &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_Flags, _To.m_Flags, _Context);
		CppConvertReverse(_From.m_StartValue, _To.m_StartValue, _Context);
		CppConvertReverse(_From.m_StartUnit, _To.m_StartUnit, _Context);
	}
};

template <>
class TCCppConvert<HPMDashboardChartPresentationConfig, NInternal_C::HPMDashboardChartPresentationConfig>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMDashboardChartPresentationConfig const &_From, NInternal_C::HPMDashboardChartPresentationConfig &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_Enabled, _To.m_Enabled, _Context);
		CppConvert(_From.m_Type, _To.m_Type, _Context);
		CppConvert(_From.m_Legend, _To.m_Legend, _Context);
		CppConvert(_From.m_Labels, _To.m_Labels, _Context);
		CppConvert(_From.m_Grouping, _To.m_Grouping, _Context);
		CppConvert(_From.m_Orientation, _To.m_Orientation, _Context);
		CppConvert(_From.m_Bounds, _To.m_Bounds, _Context);
		CppConvert(_From.m_IdealBurndown, _To.m_IdealBurndown, _Context);
		CppConvert(_From.m_Theme, _To.m_pTheme, _Context);
	}
};
template <>
class TCCppConvertReverse<NInternal_C::HPMDashboardChartPresentationConfig, HPMDashboardChartPresentationConfig>
{
public:
	static void Convert(NInternal_C::HPMDashboardChartPresentationConfig const &_From, HPMDashboardChartPresentationConfig &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_Enabled, _To.m_Enabled, _Context);
		CppConvertReverse(_From.m_Type, _To.m_Type, _Context);
		CppConvertReverse(_From.m_Legend, _To.m_Legend, _Context);
		CppConvertReverse(_From.m_Labels, _To.m_Labels, _Context);
		CppConvertReverse(_From.m_Grouping, _To.m_Grouping, _Context);
		CppConvertReverse(_From.m_Orientation, _To.m_Orientation, _Context);
		CppConvertReverse(_From.m_Bounds, _To.m_Bounds, _Context);
		CppConvertReverse(_From.m_IdealBurndown, _To.m_IdealBurndown, _Context);
		CppConvertReverse(_From.m_pTheme, _To.m_Theme, _Context);
	}
};

template <>
class TCCppConvert<HPMDashboardChartSubscription, NInternal_C::HPMDashboardChartSubscription>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMDashboardChartSubscription const &_From, NInternal_C::HPMDashboardChartSubscription &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_ChartID, _To.m_ChartID, _Context);
...
template <>
class TCCppConvertReverse<NInternal_C::HPMDashboardChartSubscription, HPMDashboardChartSubscription>
{
public:
	static void Convert(NInternal_C::HPMDashboardChartSubscription const &_From, HPMDashboardChartSubscription &_To, CCppConvertContext &_Context)
	{
		_To.SetOriginalObject(_Context.m_pSDKFunctions, _Context.m_pSession, (void *)&_From);
		CppConvertReverse(_From.m_ChartID, _To.m_ChartID, _Context);
	}
...
template <>
class TCCppConvert<HPMDashboardChartSubscription, const NInternal_C::HPMDashboardChartSubscription *>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMDashboardChartSubscription const &_From, const NInternal_C::HPMDashboardChartSubscription * &_To, CCppConvertContext &_Context)
	{
		_To = _From.GetOriginalObject();
	}
};
template <>
class TCCppConvertReverse<const NInternal_C::HPMDashboardChartSubscription* , HPMDashboardChartSubscription>
{
public:
	static void Convert(const NInternal_C::HPMDashboardChartSubscription * const &_From, HPMDashboardChartSubscription &_To, CCppConvertContext &_Context)
	{
		_To.SetOriginalObject(_Context.m_pSDKFunctions, _Context.m_pSession, (void *)_From);
	}
};
...
template <>
class TCCppConvert<HPMDashboardChartResultSetValue, NInternal_C::HPMDashboardChartResultSetValue>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMDashboardChartResultSetValue const &_From, NInternal_C::HPMDashboardChartResultSetValue &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_Index, _To.m_Index, _Context);
		CppConvert(_From.m_VariantData, _To.m_pVariantData, _Context);
	}
};
template <>
class TCCppConvertReverse<NInternal_C::HPMDashboardChartResultSetValue, HPMDashboardChartResultSetValue>
{
public:
	static void Convert(NInternal_C::HPMDashboardChartResultSetValue const &_From, HPMDashboardChartResultSetValue &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_Index, _To.m_Index, _Context);
		CppConvertReverse(_From.m_pVariantData, _To.m_VariantData, _Context);
	}
};

template <>
class TCCppConvert<HPMDashboardChartResultSetRow, NInternal_C::HPMDashboardChartResultSetRow>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	public:
		std::vector<NInternal_C::HPMDashboardChartResultSetValue> m_Values;
	};
	
	static void Convert(HPMDashboardChartResultSetRow const &_From, NInternal_C::HPMDashboardChartResultSetRow &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		{
...
template <>
class TCCppConvertReverse<NInternal_C::HPMDashboardChartResultSetRow, HPMDashboardChartResultSetRow>
{
public:
	static void Convert(NInternal_C::HPMDashboardChartResultSetRow const &_From, HPMDashboardChartResultSetRow &_To, CCppConvertContext &_Context)
	{
		{
			size_t nMembers = _From.m_nValues;
			_To.m_Values.resize(nMembers);
...
template <>
class TCCppConvert<HPMDashboardChartResultSetElementInfo, NInternal_C::HPMDashboardChartResultSetElementInfo>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMDashboardChartResultSetElementInfo const &_From, NInternal_C::HPMDashboardChartResultSetElementInfo &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_Type, _To.m_Type, _Context);
		CppConvert(_From.m_SubType, _To.m_SubType, _Context);
		CppConvert(_From.m_Index, _To.m_Index, _Context);
		CppConvert(_From.m_ValueLimitLower, _To.m_ValueLimitLower, _Context);
		CppConvert(_From.m_ValueLimitUpper, _To.m_ValueLimitUpper, _Context);
		CppConvert(_From.m_Name, _To.m_pName, _Context);
	}
};
template <>
class TCCppConvertReverse<NInternal_C::HPMDashboardChartResultSetElementInfo, HPMDashboardChartResultSetElementInfo>
{
public:
	static void Convert(NInternal_C::HPMDashboardChartResultSetElementInfo const &_From, HPMDashboardChartResultSetElementInfo &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_Type, _To.m_Type, _Context);
		CppConvertReverse(_From.m_SubType, _To.m_SubType, _Context);
		CppConvertReverse(_From.m_Index, _To.m_Index, _Context);
		CppConvertReverse(_From.m_ValueLimitLower, _To.m_ValueLimitLower, _Context);
		CppConvertReverse(_From.m_ValueLimitUpper, _To.m_ValueLimitUpper, _Context);
		CppConvertReverse(_From.m_pName, _To.m_Name, _Context);
	}
};

template <>
class TCCppConvert<HPMDashboardChartResultSetMeasures, NInternal_C::HPMDashboardChartResultSetMeasures>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	public:
		std::vector<NInternal_C::HPMDashboardChartResultSetElementInfo> m_MeasureInfos;
		std::vector<NInternal_C::HPMDashboardChartResultSetRow> m_Rows;
	};
	
	static void Convert(HPMDashboardChartResultSetMeasures const &_From, NInternal_C::HPMDashboardChartResultSetMeasures &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		{
			size_t nMembers = _From.m_MeasureInfos.size();
			pLocal->m_MeasureInfos.resize(nMembers);
			_To.m_nMeasureInfos = (unsigned int)nMembers;
			if (nMembers)
				_To.m_pMeasureInfos = &(*pLocal->m_MeasureInfos.begin());
			else
				_To.m_pMeasureInfos = 0;
			for (size_t i = 0; i < nMembers; ++i)
			{
				CppConvert(_From.m_MeasureInfos[i], pLocal->m_MeasureInfos[i], _Context);
			}
		}
		{
			size_t nMembers = _From.m_Rows.size();
...
template <>
class TCCppConvertReverse<NInternal_C::HPMDashboardChartResultSetMeasures, HPMDashboardChartResultSetMeasures>
{
public:
	static void Convert(NInternal_C::HPMDashboardChartResultSetMeasures const &_From, HPMDashboardChartResultSetMeasures &_To, CCppConvertContext &_Context)
	{
		{
			size_t nMembers = _From.m_nMeasureInfos;
			_To.m_MeasureInfos.resize(nMembers);
			for (size_t i = 0; i < nMembers; ++i)
			{
				CppConvertReverse(_From.m_pMeasureInfos[i], _To.m_MeasureInfos[i], _Context);
			}
		}
		{
			size_t nMembers = _From.m_nRows;
...
template <>
class TCCppConvert<HPMDashboardChartResultSetDimensions, NInternal_C::HPMDashboardChartResultSetDimensions>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	public:
		std::vector<NInternal_C::HPMDashboardChartResultSetElementInfo> m_DimensionInfos;
		std::vector<NInternal_C::HPMDashboardChartResultSetRow> m_Rows;
	};
	
	static void Convert(HPMDashboardChartResultSetDimensions const &_From, NInternal_C::HPMDashboardChartResultSetDimensions &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		{
			size_t nMembers = _From.m_DimensionInfos.size();
			pLocal->m_DimensionInfos.resize(nMembers);
			_To.m_nDimensionInfos = (unsigned int)nMembers;
			if (nMembers)
				_To.m_pDimensionInfos = &(*pLocal->m_DimensionInfos.begin());
			else
				_To.m_pDimensionInfos = 0;
			for (size_t i = 0; i < nMembers; ++i)
			{
				CppConvert(_From.m_DimensionInfos[i], pLocal->m_DimensionInfos[i], _Context);
			}
		}
		{
			size_t nMembers = _From.m_Rows.size();
...
template <>
class TCCppConvertReverse<NInternal_C::HPMDashboardChartResultSetDimensions, HPMDashboardChartResultSetDimensions>
{
public:
	static void Convert(NInternal_C::HPMDashboardChartResultSetDimensions const &_From, HPMDashboardChartResultSetDimensions &_To, CCppConvertContext &_Context)
	{
		{
			size_t nMembers = _From.m_nDimensionInfos;
			_To.m_DimensionInfos.resize(nMembers);
			for (size_t i = 0; i < nMembers; ++i)
			{
				CppConvertReverse(_From.m_pDimensionInfos[i], _To.m_DimensionInfos[i], _Context);
			}
		}
		{
			size_t nMembers = _From.m_nRows;
...
template <>
class TCCppConvert<HPMDashboardChartResultSet, NInternal_C::HPMDashboardChartResultSet>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMDashboardChartResultSet const &_From, NInternal_C::HPMDashboardChartResultSet &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_Info, _To.m_Info, _Context);
		CppConvert(_From.m_Config, _To.m_Config, _Context);
		CppConvert(_From.m_Dimensions, _To.m_Dimensions, _Context);
		CppConvert(_From.m_Measures, _To.m_Measures, _Context);
	}
};
template <>
class TCCppConvertReverse<NInternal_C::HPMDashboardChartResultSet, HPMDashboardChartResultSet>
{
public:
	static void Convert(NInternal_C::HPMDashboardChartResultSet const &_From, HPMDashboardChartResultSet &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_Info, _To.m_Info, _Context);
		CppConvertReverse(_From.m_Config, _To.m_Config, _Context);
		CppConvertReverse(_From.m_Dimensions, _To.m_Dimensions, _Context);
		CppConvertReverse(_From.m_Measures, _To.m_Measures, _Context);
	}
};

template <>
class TCCppConvert<HPMDashboardChartDataIdentifier, NInternal_C::HPMDashboardChartDataIdentifier>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMDashboardChartDataIdentifier const &_From, NInternal_C::HPMDashboardChartDataIdentifier &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_ID, _To.m_ID, _Context);
		CppConvert(_From.m_IDData, _To.m_IDData, _Context);
		CppConvert(_From.m_ContainerID, _To.m_ContainerID, _Context);
	}
};
template <>
class TCCppConvertReverse<NInternal_C::HPMDashboardChartDataIdentifier, HPMDashboardChartDataIdentifier>
{
public:
	static void Convert(NInternal_C::HPMDashboardChartDataIdentifier const &_From, HPMDashboardChartDataIdentifier &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_ID, _To.m_ID, _Context);
		CppConvertReverse(_From.m_IDData, _To.m_IDData, _Context);
		CppConvertReverse(_From.m_ContainerID, _To.m_ContainerID, _Context);
	}
};

template <>
class TCCppConvert<HPMDashboardChartLimitTime, NInternal_C::HPMDashboardChartLimitTime>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMDashboardChartLimitTime const &_From, NInternal_C::HPMDashboardChartLimitTime &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_Start, _To.m_Start, _Context);
...
template <>
class TCCppConvertReverse<NInternal_C::HPMDashboardChartLimitTime, HPMDashboardChartLimitTime>
{
public:
	static void Convert(NInternal_C::HPMDashboardChartLimitTime const &_From, HPMDashboardChartLimitTime &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_Start, _To.m_Start, _Context);
		CppConvertReverse(_From.m_End, _To.m_End, _Context);
	}
...
template <>
class TCCppConvert<HPMDashboardChartLimitNumericValue, NInternal_C::HPMDashboardChartLimitNumericValue>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMDashboardChartLimitNumericValue const &_From, NInternal_C::HPMDashboardChartLimitNumericValue &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_NumericValue, _To.m_NumericValue, _Context);
	}
};
template <>
class TCCppConvertReverse<NInternal_C::HPMDashboardChartLimitNumericValue, HPMDashboardChartLimitNumericValue>
{
public:
	static void Convert(NInternal_C::HPMDashboardChartLimitNumericValue const &_From, HPMDashboardChartLimitNumericValue &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_NumericValue, _To.m_NumericValue, _Context);
	}
};

template <>
class TCCppConvert<HPMDashboardChartLimitByDataIdentifiers, NInternal_C::HPMDashboardChartLimitByDataIdentifiers>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	public:
		std::vector<NInternal_C::HPMDashboardChartDataIdentifier> m_Identifiers;
	};
	
	static void Convert(HPMDashboardChartLimitByDataIdentifiers const &_From, NInternal_C::HPMDashboardChartLimitByDataIdentifiers &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		{
			size_t nMembers = _From.m_Identifiers.size();
			pLocal->m_Identifiers.resize(nMembers);
			_To.m_nIdentifiers = (unsigned int)nMembers;
			if (nMembers)
				_To.m_pIdentifiers = &(*pLocal->m_Identifiers.begin());
			else
				_To.m_pIdentifiers = 0;
			for (size_t i = 0; i < nMembers; ++i)
			{
				CppConvert(_From.m_Identifiers[i], pLocal->m_Identifiers[i], _Context);
			}
		}
	}
};
template <>
class TCCppConvertReverse<NInternal_C::HPMDashboardChartLimitByDataIdentifiers, HPMDashboardChartLimitByDataIdentifiers>
{
public:
	static void Convert(NInternal_C::HPMDashboardChartLimitByDataIdentifiers const &_From, HPMDashboardChartLimitByDataIdentifiers &_To, CCppConvertContext &_Context)
	{
		{
			size_t nMembers = _From.m_nIdentifiers;
			_To.m_Identifiers.resize(nMembers);
			for (size_t i = 0; i < nMembers; ++i)
			{
				CppConvertReverse(_From.m_pIdentifiers[i], _To.m_Identifiers[i], _Context);
			}
		}
	}
};
...
template <>
class TCCppConvert<HPMDashboardChartLimit, NInternal_C::HPMDashboardChartLimit>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMDashboardChartLimit const &_From, NInternal_C::HPMDashboardChartLimit &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_LimitType, _To.m_LimitType, _Context);
		CppConvert(_From.m_LimitByDataIdentifiers, _To.m_LimitByDataIdentifiers, _Context);
		CppConvert(_From.m_LimitByTime, _To.m_LimitByTime, _Context);
		CppConvert(_From.m_LimitByNumericValue, _To.m_LimitByNumericValue, _Context);
	}
};
template <>
class TCCppConvertReverse<NInternal_C::HPMDashboardChartLimit, HPMDashboardChartLimit>
{
public:
	static void Convert(NInternal_C::HPMDashboardChartLimit const &_From, HPMDashboardChartLimit &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_LimitType, _To.m_LimitType, _Context);
		CppConvertReverse(_From.m_LimitByDataIdentifiers, _To.m_LimitByDataIdentifiers, _Context);
		CppConvertReverse(_From.m_LimitByTime, _To.m_LimitByTime, _Context);
		CppConvertReverse(_From.m_LimitByNumericValue, _To.m_LimitByNumericValue, _Context);
	}
};

template <>
class TCCppConvert<HPMDashboardChartItemViewConfig, NInternal_C::HPMDashboardChartItemViewConfig>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	public:
		std::vector<NInternal_C::HPMColumn> m_VisibleColumns;
	};
	
	static void Convert(HPMDashboardChartItemViewConfig const &_From, NInternal_C::HPMDashboardChartItemViewConfig &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		{
			size_t nMembers = _From.m_VisibleColumns.size();
			pLocal->m_VisibleColumns.resize(nMembers);
			_To.m_nVisibleColumns = (unsigned int)nMembers;
			if (nMembers)
				_To.m_pVisibleColumns = &(*pLocal->m_VisibleColumns.begin());
			else
				_To.m_pVisibleColumns = 0;
			for (size_t i = 0; i < nMembers; ++i)
			{
				CppConvert(_From.m_VisibleColumns[i], pLocal->m_VisibleColumns[i], _Context);
			}
		}
		CppConvert(_From.m_SortingColumn, _To.m_SortingColumn, _Context);
		CppConvert(_From.m_SortDirection, _To.m_SortDirection, _Context);
	}
};
template <>
class TCCppConvertReverse<NInternal_C::HPMDashboardChartItemViewConfig, HPMDashboardChartItemViewConfig>
{
public:
	static void Convert(NInternal_C::HPMDashboardChartItemViewConfig const &_From, HPMDashboardChartItemViewConfig &_To, CCppConvertContext &_Context)
	{
		{
			size_t nMembers = _From.m_nVisibleColumns;
			_To.m_VisibleColumns.resize(nMembers);
			for (size_t i = 0; i < nMembers; ++i)
			{
				CppConvertReverse(_From.m_pVisibleColumns[i], _To.m_VisibleColumns[i], _Context);
			}
		}
		CppConvertReverse(_From.m_SortingColumn, _To.m_SortingColumn, _Context);
		CppConvertReverse(_From.m_SortDirection, _To.m_SortDirection, _Context);
	}
};

template <>
class TCCppConvert<HPMDashboardChartFilter, NInternal_C::HPMDashboardChartFilter>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMDashboardChartFilter const &_From, NInternal_C::HPMDashboardChartFilter &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_Category, _To.m_Category, _Context);
		CppConvert(_From.m_Identifier, _To.m_Identifier, _Context);
		CppConvert(_From.m_CompleteReport, _To.m_CompleteReport, _Context);
	}
};
template <>
class TCCppConvertReverse<NInternal_C::HPMDashboardChartFilter, HPMDashboardChartFilter>
{
public:
	static void Convert(NInternal_C::HPMDashboardChartFilter const &_From, HPMDashboardChartFilter &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_Category, _To.m_Category, _Context);
		CppConvertReverse(_From.m_Identifier, _To.m_Identifier, _Context);
		CppConvertReverse(_From.m_CompleteReport, _To.m_CompleteReport, _Context);
	}
};

template <>
class TCCppConvert<HPMDashboardChartForecastingConfig, NInternal_C::HPMDashboardChartForecastingConfig>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMDashboardChartForecastingConfig const &_From, NInternal_C::HPMDashboardChartForecastingConfig &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_DateRange, _To.m_DateRange, _Context);
		CppConvert(_From.m_Limit, _To.m_Limit, _Context);
		CppConvert(_From.m_VelocityMethod, _To.m_VelocityMethod, _Context);
		CppConvert(_From.m_VelocityMethodValue, _To.m_VelocityMethodValue, _Context);
	}
};
template <>
class TCCppConvertReverse<NInternal_C::HPMDashboardChartForecastingConfig, HPMDashboardChartForecastingConfig>
{
public:
	static void Convert(NInternal_C::HPMDashboardChartForecastingConfig const &_From, HPMDashboardChartForecastingConfig &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_DateRange, _To.m_DateRange, _Context);
		CppConvertReverse(_From.m_Limit, _To.m_Limit, _Context);
		CppConvertReverse(_From.m_VelocityMethod, _To.m_VelocityMethod, _Context);
		CppConvertReverse(_From.m_VelocityMethodValue, _To.m_VelocityMethodValue, _Context);
	}
};

template <>
class TCCppConvert<HPMDashboardChartDimension, NInternal_C::HPMDashboardChartDimension>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMDashboardChartDimension const &_From, NInternal_C::HPMDashboardChartDimension &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_Enabled, _To.m_Enabled, _Context);
		CppConvert(_From.m_Category, _To.m_Category, _Context);
		CppConvert(_From.m_SubCategory, _To.m_SubCategory, _Context);
		CppConvert(_From.m_TimeRange, _To.m_TimeRange, _Context);
		CppConvert(_From.m_TimeResolution, _To.m_TimeResolution, _Context);
		CppConvert(_From.m_SortMethod, _To.m_SortMethod, _Context);
		CppConvert(_From.m_SortDirection, _To.m_SortDirection, _Context);
		CppConvert(_From.m_GroupExpansion, _To.m_GroupExpansion, _Context);
		CppConvert(_From.m_Limit, _To.m_Limit, _Context);
		CppConvert(_From.m_Forecasting, _To.m_Forecasting, _Context);
	}
};
template <>
class TCCppConvertReverse<NInternal_C::HPMDashboardChartDimension, HPMDashboardChartDimension>
{
public:
	static void Convert(NInternal_C::HPMDashboardChartDimension const &_From, HPMDashboardChartDimension &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_Enabled, _To.m_Enabled, _Context);
		CppConvertReverse(_From.m_Category, _To.m_Category, _Context);
		CppConvertReverse(_From.m_SubCategory, _To.m_SubCategory, _Context);
		CppConvertReverse(_From.m_TimeRange, _To.m_TimeRange, _Context);
		CppConvertReverse(_From.m_TimeResolution, _To.m_TimeResolution, _Context);
		CppConvertReverse(_From.m_SortMethod, _To.m_SortMethod, _Context);
		CppConvertReverse(_From.m_SortDirection, _To.m_SortDirection, _Context);
		CppConvertReverse(_From.m_GroupExpansion, _To.m_GroupExpansion, _Context);
		CppConvertReverse(_From.m_Limit, _To.m_Limit, _Context);
		CppConvertReverse(_From.m_Forecasting, _To.m_Forecasting, _Context);
	}
};

template <>
class TCCppConvert<HPMDashboardChartMeasure, NInternal_C::HPMDashboardChartMeasure>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMDashboardChartMeasure const &_From, NInternal_C::HPMDashboardChartMeasure &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_Category, _To.m_Category, _Context);
		CppConvert(_From.m_CustomName, _To.m_pCustomName, _Context);
		CppConvert(_From.m_TimeRange, _To.m_TimeRange, _Context);
		CppConvert(_From.m_Limit, _To.m_Limit, _Context);
		CppConvert(_From.m_AllocationType, _To.m_AllocationType, _Context);
		{
			size_t nMembers = _From.m_Identifiers.size();
			pLocal->m_Identifiers.resize(nMembers);
			_To.m_nIdentifiers = (unsigned int)nMembers;
		...
		CppConvert(_From.m_BurndownType, _To.m_BurndownType, _Context);
		CppConvert(_From.m_AggregationFunction, _To.m_AggregationFunction, _Context);
		CppConvert(_From.m_ScaleByFinalValue, _To.m_ScaleByFinalValue, _Context);
		CppConvert(_From.m_bScaleByAllocation, _To.m_bScaleByAllocation, _Context);
	}
};
template <>
class TCCppConvertReverse<NInternal_C::HPMDashboardChartMeasure, HPMDashboardChartMeasure>
{
public:
	static void Convert(NInternal_C::HPMDashboardChartMeasure const &_From, HPMDashboardChartMeasure &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_Category, _To.m_Category, _Context);
		CppConvertReverse(_From.m_pCustomName, _To.m_CustomName, _Context);
		CppConvertReverse(_From.m_TimeRange, _To.m_TimeRange, _Context);
		CppConvertReverse(_From.m_Limit, _To.m_Limit, _Context);
		CppConvertReverse(_From.m_AllocationType, _To.m_AllocationType, _Context);
		{
			size_t nMembers = _From.m_nIdentifiers;
			_To.m_Identifiers.resize(nMembers);
			for (size_t i = 0; i < nMembers; ++i)
		...
		CppConvertReverse(_From.m_BurndownType, _To.m_BurndownType, _Context);
		CppConvertReverse(_From.m_AggregationFunction, _To.m_AggregationFunction, _Context);
		CppConvertReverse(_From.m_ScaleByFinalValue, _To.m_ScaleByFinalValue, _Context);
		CppConvertReverse(_From.m_bScaleByAllocation, _To.m_bScaleByAllocation, _Context);
	}
};

template <>
class TCCppConvert<HPMDashboardChartComputationConfig, NInternal_C::HPMDashboardChartComputationConfig>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	public:
		std::vector<NInternal_C::HPMDashboardChartFilter> m_Filters;
		std::vector<NInternal_C::HPMDashboardChartDimension> m_Dimensions;
		std::vector<NInternal_C::HPMDashboardChartMeasure> m_Measures;
	};
	
	static void Convert(HPMDashboardChartComputationConfig const &_From, NInternal_C::HPMDashboardChartComputationConfig &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_ChartOwner, _To.m_ChartOwner, _Context);
		{
		...
		{
			size_t nMembers = _From.m_Dimensions.size();
			pLocal->m_Dimensions.resize(nMembers);
			_To.m_nDimensions = (unsigned int)nMembers;
			if (nMembers)
				_To.m_pDimensions = &(*pLocal->m_Dimensions.begin());
			else
				_To.m_pDimensions = 0;
			for (size_t i = 0; i < nMembers; ++i)
			{
				CppConvert(_From.m_Dimensions[i], pLocal->m_Dimensions[i], _Context);
			}
		}
		{
			size_t nMembers = _From.m_Measures.size();
			pLocal->m_Measures.resize(nMembers);
			_To.m_nMeasures = (unsigned int)nMembers;
			if (nMembers)
				_To.m_pMeasures = &(*pLocal->m_Measures.begin());
			else
				_To.m_pMeasures = 0;
			for (size_t i = 0; i < nMembers; ++i)
			{
				CppConvert(_From.m_Measures[i], pLocal->m_Measures[i], _Context);
			}
		}
		CppConvert(_From.m_ItemViewConfig, _To.m_ItemViewConfig, _Context);
		CppConvert(_From.m_bSupressZeroValues, _To.m_bSupressZeroValues, _Context);
		CppConvert(_From.m_ShowHistoricalDataFromDate, _To.m_ShowHistoricalDataFromDate, _Context);
		CppConvert(_From.m_EarliestSampledTime, _To.m_EarliestSampledTime, _Context);
		CppConvert(_From.m_OriginalVersion, _To.m_OriginalVersion, _Context);
	}
};
template <>
class TCCppConvertReverse<NInternal_C::HPMDashboardChartComputationConfig, HPMDashboardChartComputationConfig>
{
public:
	static void Convert(NInternal_C::HPMDashboardChartComputationConfig const &_From, HPMDashboardChartComputationConfig &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_ChartOwner, _To.m_ChartOwner, _Context);
		{
		...
		{
			size_t nMembers = _From.m_nDimensions;
			_To.m_Dimensions.resize(nMembers);
			for (size_t i = 0; i < nMembers; ++i)
			{
				CppConvertReverse(_From.m_pDimensions[i], _To.m_Dimensions[i], _Context);
			}
		}
		{
			size_t nMembers = _From.m_nMeasures;
			_To.m_Measures.resize(nMembers);
			for (size_t i = 0; i < nMembers; ++i)
			{
				CppConvertReverse(_From.m_pMeasures[i], _To.m_Measures[i], _Context);
			}
		}
		CppConvertReverse(_From.m_ItemViewConfig, _To.m_ItemViewConfig, _Context);
		CppConvertReverse(_From.m_bSupressZeroValues, _To.m_bSupressZeroValues, _Context);
		CppConvertReverse(_From.m_ShowHistoricalDataFromDate, _To.m_ShowHistoricalDataFromDate, _Context);
		CppConvertReverse(_From.m_EarliestSampledTime, _To.m_EarliestSampledTime, _Context);
		CppConvertReverse(_From.m_OriginalVersion, _To.m_OriginalVersion, _Context);
	}
};

template <>
class TCCppConvert<HPMDashboardChartHistoricComputationConfigs, NInternal_C::HPMDashboardChartHistoricComputationConfigs>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	public:
		std::vector<NInternal_C::HPMDashboardChartComputationConfig> m_Configurations;
	};
	
	static void Convert(HPMDashboardChartHistoricComputationConfigs const &_From, NInternal_C::HPMDashboardChartHistoricComputationConfigs &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		{
			size_t nMembers = _From.m_Configurations.size();
			pLocal->m_Configurations.resize(nMembers);
			_To.m_nConfigurations = (unsigned int)nMembers;
			if (nMembers)
				_To.m_pConfigurations = &(*pLocal->m_Configurations.begin());
			else
				_To.m_pConfigurations = 0;
			for (size_t i = 0; i < nMembers; ++i)
			{
				CppConvert(_From.m_Configurations[i], pLocal->m_Configurations[i], _Context);
			}
		}
	}
};
template <>
class TCCppConvertReverse<NInternal_C::HPMDashboardChartHistoricComputationConfigs, HPMDashboardChartHistoricComputationConfigs>
{
public:
	static void Convert(NInternal_C::HPMDashboardChartHistoricComputationConfigs const &_From, HPMDashboardChartHistoricComputationConfigs &_To, CCppConvertContext &_Context)
	{
		{
			size_t nMembers = _From.m_nConfigurations;
			_To.m_Configurations.resize(nMembers);
			for (size_t i = 0; i < nMembers; ++i)
			{
				CppConvertReverse(_From.m_pConfigurations[i], _To.m_Configurations[i], _Context);
			}
		}
	}
};
...
template <>
class TCCppConvert<HPMDashboardChartValidationResult, NInternal_C::HPMDashboardChartValidationResult>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMDashboardChartValidationResult const &_From, NInternal_C::HPMDashboardChartValidationResult &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_bValid, _To.m_bValid, _Context);
		CppConvert(_From.m_Error, _To.m_pError, _Context);
	}
};
template <>
class TCCppConvertReverse<NInternal_C::HPMDashboardChartValidationResult, HPMDashboardChartValidationResult>
{
public:
	static void Convert(NInternal_C::HPMDashboardChartValidationResult const &_From, HPMDashboardChartValidationResult &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_bValid, _To.m_bValid, _Context);
		CppConvertReverse(_From.m_pError, _To.m_Error, _Context);
	}
};

template <>
class TCCppConvert<HPMDashboardThemes, NInternal_C::HPMDashboardThemes>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	public:
		std::vector<NInternal_C::HPMString> m_Themes;
	};
	
	static void Convert(HPMDashboardThemes const &_From, NInternal_C::HPMDashboardThemes &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		{
			size_t nMembers = _From.m_Themes.size();
			pLocal->m_Themes.resize(nMembers);
			_To.m_nThemes = (unsigned int)nMembers;
			if (nMembers)
				_To.m_pThemes = &(*pLocal->m_Themes.begin());
			else
				_To.m_pThemes = 0;
			for (size_t i = 0; i < nMembers; ++i)
			{
				CppConvert(_From.m_Themes[i], pLocal->m_Themes[i], _Context);
			}
		}
	}
};
template <>
class TCCppConvertReverse<NInternal_C::HPMDashboardThemes, HPMDashboardThemes>
{
public:
	static void Convert(NInternal_C::HPMDashboardThemes const &_From, HPMDashboardThemes &_To, CCppConvertContext &_Context)
	{
		{
			size_t nMembers = _From.m_nThemes;
			_To.m_Themes.resize(nMembers);
			for (size_t i = 0; i < nMembers; ++i)
			{
				CppConvertReverse(_From.m_pThemes[i], _To.m_Themes[i], _Context);
			}
		}
	}
};
...
public:
	...
	static void Convert(HPMChangeCallbackData_ProjectWorkflowChange const &_From, NInternal_C::HPMChangeCallbackData_ProjectWorkflowChange &_To, CCppConvertContext &_Context)
	{
		...
		CppConvert(_From.m_ProjectID, _To.m_ProjectID, _Context);
		CppConvert(_From.m_WorkflowID, _To.m_WorkflowID, _Context);
		CppConvert(_From.m_bValidChange, _To.m_bValidChange, _Context);
	}
};
template <>
...
public:
	static void Convert(NInternal_C::HPMChangeCallbackData_ProjectWorkflowChange const &_From, HPMChangeCallbackData_ProjectWorkflowChange &_To, CCppConvertContext &_Context)
	{
		...
		CppConvertReverse(_From.m_ProjectID, _To.m_ProjectID, _Context);
		CppConvertReverse(_From.m_WorkflowID, _To.m_WorkflowID, _Context);
		CppConvertReverse(_From.m_bValidChange, _To.m_bValidChange, _Context);
	}
};
...
template <>
class TCCppConvert<HPMChangeCallbackData_DashboardChartReceive, NInternal_C::HPMChangeCallbackData_DashboardChartReceive>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMChangeCallbackData_DashboardChartReceive const &_From, NInternal_C::HPMChangeCallbackData_DashboardChartReceive &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_ChartID, _To.m_ChartID, _Context);
		CppConvert(_From.m_FirstSampledAt, _To.m_FirstSampledAt, _Context);
		CppConvert(_From.m_LastSampledAt, _To.m_LastSampledAt, _Context);
	}
};
template <>
class TCCppConvertReverse<NInternal_C::HPMChangeCallbackData_DashboardChartReceive, HPMChangeCallbackData_DashboardChartReceive>
{
public:
	static void Convert(NInternal_C::HPMChangeCallbackData_DashboardChartReceive const &_From, HPMChangeCallbackData_DashboardChartReceive &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_ChartID, _To.m_ChartID, _Context);
		CppConvertReverse(_From.m_FirstSampledAt, _To.m_FirstSampledAt, _Context);
		CppConvertReverse(_From.m_LastSampledAt, _To.m_LastSampledAt, _Context);
	}
};

template <>
class TCCppConvert<HPMChangeCallbackData_DashboardChartCreate, NInternal_C::HPMChangeCallbackData_DashboardChartCreate>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMChangeCallbackData_DashboardChartCreate const &_From, NInternal_C::HPMChangeCallbackData_DashboardChartCreate &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_bChangeInitiatedFromThisSession, _To.m_bChangeInitiatedFromThisSession, _Context);
		...
		CppConvert(_From.m_ChangedByImpersonatedResourceID, _To.m_ChangedByImpersonatedResourceID, _Context);
		CppConvert(_From.m_ChartID, _To.m_ChartID, _Context);
		CppConvert(_From.m_LocalObjectID, _To.m_LocalObjectID, _Context);
		CppConvert(_From.m_PageID, _To.m_PageID, _Context);
	}
};
template <>
class TCCppConvertReverse<NInternal_C::HPMChangeCallbackData_DashboardChartCreate, HPMChangeCallbackData_DashboardChartCreate>
{
public:
	static void Convert(NInternal_C::HPMChangeCallbackData_DashboardChartCreate const &_From, HPMChangeCallbackData_DashboardChartCreate &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_bChangeInitiatedFromThisSession, _To.m_bChangeInitiatedFromThisSession, _Context);
		CppConvertReverse(_From.m_ChangedByResourceID, _To.m_ChangedByResourceID, _Context);
		CppConvertReverse(_From.m_ChangedByImpersonatedResourceID, _To.m_ChangedByImpersonatedResourceID, _Context);
		CppConvertReverse(_From.m_ChartID, _To.m_ChartID, _Context);
		CppConvertReverse(_From.m_LocalObjectID, _To.m_LocalObjectID, _Context);
		CppConvertReverse(_From.m_PageID, _To.m_PageID, _Context);
	}
};

template <>
class TCCppConvert<HPMChangeCallbackData_DashboardComputationConfigurationChange, NInternal_C::HPMChangeCallbackData_DashboardComputationConfigurationChange>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMChangeCallbackData_DashboardComputationConfigurationChange const &_From, NInternal_C::HPMChangeCallbackData_DashboardComputationConfigurationChange &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_bChangeInitiatedFromThisSession, _To.m_bChangeInitiatedFromThisSession, _Context);
...
template <>
class TCCppConvertReverse<NInternal_C::HPMChangeCallbackData_DashboardComputationConfigurationChange, HPMChangeCallbackData_DashboardComputationConfigurationChange>
{
public:
	static void Convert(NInternal_C::HPMChangeCallbackData_DashboardComputationConfigurationChange const &_From, HPMChangeCallbackData_DashboardComputationConfigurationChange &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_bChangeInitiatedFromThisSession, _To.m_bChangeInitiatedFromThisSession, _Context);
		CppConvertReverse(_From.m_ChangedByResourceID, _To.m_ChangedByResourceID, _Context);
		CppConvertReverse(_From.m_ChangedByImpersonatedResourceID, _To.m_ChangedByImpersonatedResourceID, _Context);
...
template <>
class TCCppConvert<HPMChangeCallbackData_DashboardPresentationConfigurationChange, NInternal_C::HPMChangeCallbackData_DashboardPresentationConfigurationChange>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMChangeCallbackData_DashboardPresentationConfigurationChange const &_From, NInternal_C::HPMChangeCallbackData_DashboardPresentationConfigurationChange &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_bChangeInitiatedFromThisSession, _To.m_bChangeInitiatedFromThisSession, _Context);
...
template <>
class TCCppConvertReverse<NInternal_C::HPMChangeCallbackData_DashboardPresentationConfigurationChange, HPMChangeCallbackData_DashboardPresentationConfigurationChange>
{
public:
	static void Convert(NInternal_C::HPMChangeCallbackData_DashboardPresentationConfigurationChange const &_From, HPMChangeCallbackData_DashboardPresentationConfigurationChange &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_bChangeInitiatedFromThisSession, _To.m_bChangeInitiatedFromThisSession, _Context);
		CppConvertReverse(_From.m_ChangedByResourceID, _To.m_ChangedByResourceID, _Context);
		CppConvertReverse(_From.m_ChangedByImpersonatedResourceID, _To.m_ChangedByImpersonatedResourceID, _Context);
...
template <>
class TCCppConvert<HPMChangeCallbackData_DashboardChartDelete, NInternal_C::HPMChangeCallbackData_DashboardChartDelete>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMChangeCallbackData_DashboardChartDelete const &_From, NInternal_C::HPMChangeCallbackData_DashboardChartDelete &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_bChangeInitiatedFromThisSession, _To.m_bChangeInitiatedFromThisSession, _Context);
...
template <>
class TCCppConvertReverse<NInternal_C::HPMChangeCallbackData_DashboardChartDelete, HPMChangeCallbackData_DashboardChartDelete>
{
public:
	static void Convert(NInternal_C::HPMChangeCallbackData_DashboardChartDelete const &_From, HPMChangeCallbackData_DashboardChartDelete &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_bChangeInitiatedFromThisSession, _To.m_bChangeInitiatedFromThisSession, _Context);
		CppConvertReverse(_From.m_ChangedByResourceID, _To.m_ChangedByResourceID, _Context);
		CppConvertReverse(_From.m_ChangedByImpersonatedResourceID, _To.m_ChangedByImpersonatedResourceID, _Context);
...
template <>
class TCCppConvert<HPMChangeCallbackData_DashboardChartNameChange, NInternal_C::HPMChangeCallbackData_DashboardChartNameChange>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMChangeCallbackData_DashboardChartNameChange const &_From, NInternal_C::HPMChangeCallbackData_DashboardChartNameChange &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_bChangeInitiatedFromThisSession, _To.m_bChangeInitiatedFromThisSession, _Context);
...
template <>
class TCCppConvertReverse<NInternal_C::HPMChangeCallbackData_DashboardChartNameChange, HPMChangeCallbackData_DashboardChartNameChange>
{
public:
	static void Convert(NInternal_C::HPMChangeCallbackData_DashboardChartNameChange const &_From, HPMChangeCallbackData_DashboardChartNameChange &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_bChangeInitiatedFromThisSession, _To.m_bChangeInitiatedFromThisSession, _Context);
		CppConvertReverse(_From.m_ChangedByResourceID, _To.m_ChangedByResourceID, _Context);
		CppConvertReverse(_From.m_ChangedByImpersonatedResourceID, _To.m_ChangedByImpersonatedResourceID, _Context);
...
template <>
class TCCppConvert<HPMChangeCallbackData_DashboardPageCreate, NInternal_C::HPMChangeCallbackData_DashboardPageCreate>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMChangeCallbackData_DashboardPageCreate const &_From, NInternal_C::HPMChangeCallbackData_DashboardPageCreate &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_bChangeInitiatedFromThisSession, _To.m_bChangeInitiatedFromThisSession, _Context);
...
template <>
class TCCppConvertReverse<NInternal_C::HPMChangeCallbackData_DashboardPageCreate, HPMChangeCallbackData_DashboardPageCreate>
{
public:
	static void Convert(NInternal_C::HPMChangeCallbackData_DashboardPageCreate const &_From, HPMChangeCallbackData_DashboardPageCreate &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_bChangeInitiatedFromThisSession, _To.m_bChangeInitiatedFromThisSession, _Context);
		CppConvertReverse(_From.m_ChangedByResourceID, _To.m_ChangedByResourceID, _Context);
		CppConvertReverse(_From.m_ChangedByImpersonatedResourceID, _To.m_ChangedByImpersonatedResourceID, _Context);
...
template <>
class TCCppConvert<HPMChangeCallbackData_DashboardPageNameChange, NInternal_C::HPMChangeCallbackData_DashboardPageNameChange>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMChangeCallbackData_DashboardPageNameChange const &_From, NInternal_C::HPMChangeCallbackData_DashboardPageNameChange &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_bChangeInitiatedFromThisSession, _To.m_bChangeInitiatedFromThisSession, _Context);
...
template <>
class TCCppConvertReverse<NInternal_C::HPMChangeCallbackData_DashboardPageNameChange, HPMChangeCallbackData_DashboardPageNameChange>
{
public:
	static void Convert(NInternal_C::HPMChangeCallbackData_DashboardPageNameChange const &_From, HPMChangeCallbackData_DashboardPageNameChange &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_bChangeInitiatedFromThisSession, _To.m_bChangeInitiatedFromThisSession, _Context);
		CppConvertReverse(_From.m_ChangedByResourceID, _To.m_ChangedByResourceID, _Context);
		CppConvertReverse(_From.m_ChangedByImpersonatedResourceID, _To.m_ChangedByImpersonatedResourceID, _Context);
...
template <>
class TCCppConvert<HPMChangeCallbackData_DashboardThemeChange, NInternal_C::HPMChangeCallbackData_DashboardThemeChange>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMChangeCallbackData_DashboardThemeChange const &_From, NInternal_C::HPMChangeCallbackData_DashboardThemeChange &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_bChangeInitiatedFromThisSession, _To.m_bChangeInitiatedFromThisSession, _Context);
...
template <>
class TCCppConvertReverse<NInternal_C::HPMChangeCallbackData_DashboardThemeChange, HPMChangeCallbackData_DashboardThemeChange>
{
public:
	static void Convert(NInternal_C::HPMChangeCallbackData_DashboardThemeChange const &_From, HPMChangeCallbackData_DashboardThemeChange &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_bChangeInitiatedFromThisSession, _To.m_bChangeInitiatedFromThisSession, _Context);
		CppConvertReverse(_From.m_ChangedByResourceID, _To.m_ChangedByResourceID, _Context);
		CppConvertReverse(_From.m_ChangedByImpersonatedResourceID, _To.m_ChangedByImpersonatedResourceID, _Context);
...
template <>
class TCCppConvert<HPMChangeCallbackData_DashboardPageLayoutChange, NInternal_C::HPMChangeCallbackData_DashboardPageLayoutChange>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMChangeCallbackData_DashboardPageLayoutChange const &_From, NInternal_C::HPMChangeCallbackData_DashboardPageLayoutChange &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_bChangeInitiatedFromThisSession, _To.m_bChangeInitiatedFromThisSession, _Context);
...
template <>
class TCCppConvertReverse<NInternal_C::HPMChangeCallbackData_DashboardPageLayoutChange, HPMChangeCallbackData_DashboardPageLayoutChange>
{
public:
	static void Convert(NInternal_C::HPMChangeCallbackData_DashboardPageLayoutChange const &_From, HPMChangeCallbackData_DashboardPageLayoutChange &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_bChangeInitiatedFromThisSession, _To.m_bChangeInitiatedFromThisSession, _Context);
		CppConvertReverse(_From.m_ChangedByResourceID, _To.m_ChangedByResourceID, _Context);
		CppConvertReverse(_From.m_ChangedByImpersonatedResourceID, _To.m_ChangedByImpersonatedResourceID, _Context);
...
template <>
class TCCppConvert<HPMChangeCallbackData_DashboardPageSharedToWithViewingRightsChange, NInternal_C::HPMChangeCallbackData_DashboardPageSharedToWithViewingRightsChange>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMChangeCallbackData_DashboardPageSharedToWithViewingRightsChange const &_From, NInternal_C::HPMChangeCallbackData_DashboardPageSharedToWithViewingRightsChange &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_bChangeInitiatedFromThisSession, _To.m_bChangeInitiatedFromThisSession, _Context);
...
template <>
class TCCppConvertReverse<NInternal_C::HPMChangeCallbackData_DashboardPageSharedToWithViewingRightsChange, HPMChangeCallbackData_DashboardPageSharedToWithViewingRightsChange>
{
public:
	static void Convert(NInternal_C::HPMChangeCallbackData_DashboardPageSharedToWithViewingRightsChange const &_From, HPMChangeCallbackData_DashboardPageSharedToWithViewingRightsChange &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_bChangeInitiatedFromThisSession, _To.m_bChangeInitiatedFromThisSession, _Context);
		CppConvertReverse(_From.m_ChangedByResourceID, _To.m_ChangedByResourceID, _Context);
		CppConvertReverse(_From.m_ChangedByImpersonatedResourceID, _To.m_ChangedByImpersonatedResourceID, _Context);
...
template <>
class TCCppConvert<HPMChangeCallbackData_DashboardPageSharedToWithEditingRightsChange, NInternal_C::HPMChangeCallbackData_DashboardPageSharedToWithEditingRightsChange>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMChangeCallbackData_DashboardPageSharedToWithEditingRightsChange const &_From, NInternal_C::HPMChangeCallbackData_DashboardPageSharedToWithEditingRightsChange &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_bChangeInitiatedFromThisSession, _To.m_bChangeInitiatedFromThisSession, _Context);
...
template <>
class TCCppConvertReverse<NInternal_C::HPMChangeCallbackData_DashboardPageSharedToWithEditingRightsChange, HPMChangeCallbackData_DashboardPageSharedToWithEditingRightsChange>
{
public:
	static void Convert(NInternal_C::HPMChangeCallbackData_DashboardPageSharedToWithEditingRightsChange const &_From, HPMChangeCallbackData_DashboardPageSharedToWithEditingRightsChange &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_bChangeInitiatedFromThisSession, _To.m_bChangeInitiatedFromThisSession, _Context);
		CppConvertReverse(_From.m_ChangedByResourceID, _To.m_ChangedByResourceID, _Context);
		CppConvertReverse(_From.m_ChangedByImpersonatedResourceID, _To.m_ChangedByImpersonatedResourceID, _Context);
...
template <>
class TCCppConvert<HPMChangeCallbackData_DashboardPageDelete, NInternal_C::HPMChangeCallbackData_DashboardPageDelete>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMChangeCallbackData_DashboardPageDelete const &_From, NInternal_C::HPMChangeCallbackData_DashboardPageDelete &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_bChangeInitiatedFromThisSession, _To.m_bChangeInitiatedFromThisSession, _Context);
...
template <>
class TCCppConvertReverse<NInternal_C::HPMChangeCallbackData_DashboardPageDelete, HPMChangeCallbackData_DashboardPageDelete>
{
public:
	static void Convert(NInternal_C::HPMChangeCallbackData_DashboardPageDelete const &_From, HPMChangeCallbackData_DashboardPageDelete &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_bChangeInitiatedFromThisSession, _To.m_bChangeInitiatedFromThisSession, _Context);
		CppConvertReverse(_From.m_ChangedByResourceID, _To.m_ChangedByResourceID, _Context);
		CppConvertReverse(_From.m_ChangedByImpersonatedResourceID, _To.m_ChangedByImpersonatedResourceID, _Context);
...
template <>
class TCCppConvert<HPMChangeCallbackData_UserNotMemberOfProject, NInternal_C::HPMChangeCallbackData_UserNotMemberOfProject>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMChangeCallbackData_UserNotMemberOfProject const &_From, NInternal_C::HPMChangeCallbackData_UserNotMemberOfProject &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_bChangeInitiatedFromThisSession, _To.m_bChangeInitiatedFromThisSession, _Context);
...
template <>
class TCCppConvertReverse<NInternal_C::HPMChangeCallbackData_UserNotMemberOfProject, HPMChangeCallbackData_UserNotMemberOfProject>
{
public:
	static void Convert(NInternal_C::HPMChangeCallbackData_UserNotMemberOfProject const &_From, HPMChangeCallbackData_UserNotMemberOfProject &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_bChangeInitiatedFromThisSession, _To.m_bChangeInitiatedFromThisSession, _Context);
	}
};
...
template <>
class TCCppConvert<HPMChangeCallbackData_ProjectBugReportResourcesChange, NInternal_C::HPMChangeCallbackData_ProjectBugReportResourcesChange>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMChangeCallbackData_ProjectBugReportResourcesChange const &_From, NInternal_C::HPMChangeCallbackData_ProjectBugReportResourcesChange &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_bChangeInitiatedFromThisSession, _To.m_bChangeInitiatedFromThisSession, _Context);
...
template <>
class TCCppConvertReverse<NInternal_C::HPMChangeCallbackData_ProjectBugReportResourcesChange, HPMChangeCallbackData_ProjectBugReportResourcesChange>
{
public:
	static void Convert(NInternal_C::HPMChangeCallbackData_ProjectBugReportResourcesChange const &_From, HPMChangeCallbackData_ProjectBugReportResourcesChange &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_bChangeInitiatedFromThisSession, _To.m_bChangeInitiatedFromThisSession, _Context);
		CppConvertReverse(_From.m_ChangedByResourceID, _To.m_ChangedByResourceID, _Context);
		CppConvertReverse(_From.m_ChangedByImpersonatedResourceID, _To.m_ChangedByImpersonatedResourceID, _Context);
...
template <>
class TCCppConvert<HPMChangeCallbackData_ProjectDefaultQAWorkflowChange, NInternal_C::HPMChangeCallbackData_ProjectDefaultQAWorkflowChange>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMChangeCallbackData_ProjectDefaultQAWorkflowChange const &_From, NInternal_C::HPMChangeCallbackData_ProjectDefaultQAWorkflowChange &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_bChangeInitiatedFromThisSession, _To.m_bChangeInitiatedFromThisSession, _Context);
...
template <>
class TCCppConvertReverse<NInternal_C::HPMChangeCallbackData_ProjectDefaultQAWorkflowChange, HPMChangeCallbackData_ProjectDefaultQAWorkflowChange>
{
public:
	static void Convert(NInternal_C::HPMChangeCallbackData_ProjectDefaultQAWorkflowChange const &_From, HPMChangeCallbackData_ProjectDefaultQAWorkflowChange &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_bChangeInitiatedFromThisSession, _To.m_bChangeInitiatedFromThisSession, _Context);
		CppConvertReverse(_From.m_ChangedByResourceID, _To.m_ChangedByResourceID, _Context);
		CppConvertReverse(_From.m_ChangedByImpersonatedResourceID, _To.m_ChangedByImpersonatedResourceID, _Context);
...
template <>
class TCCppConvert<HPMChangeCallbackData_SharesUpdate, NInternal_C::HPMChangeCallbackData_SharesUpdate>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	...
	static void Convert(HPMChangeCallbackData_SharesUpdate const &_From, NInternal_C::HPMChangeCallbackData_SharesUpdate &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_bChangeInitiatedFromThisSession, _To.m_bChangeInitiatedFromThisSession, _Context);
...
template <>
class TCCppConvertReverse<NInternal_C::HPMChangeCallbackData_SharesUpdate, HPMChangeCallbackData_SharesUpdate>
{
public:
	static void Convert(NInternal_C::HPMChangeCallbackData_SharesUpdate const &_From, HPMChangeCallbackData_SharesUpdate &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_bChangeInitiatedFromThisSession, _To.m_bChangeInitiatedFromThisSession, _Context);
		CppConvertReverse(_From.m_ChangedByResourceID, _To.m_ChangedByResourceID, _Context);
		CppConvertReverse(_From.m_ChangedByImpersonatedResourceID, _To.m_ChangedByImpersonatedResourceID, _Context);
...
public:
	...
	static void Convert(HPMResourceProperties const &_From, NInternal_C::HPMResourceProperties &_To, CCppConvertContext &_Context)
	{
		...
		CppConvert(_From.m_SDKSyncMethod, _To.m_SDKSyncMethod, _Context);
		CppConvert(_From.m_PasswordFlags, _To.m_PasswordFlags, _Context);
		CppConvert(_From.m_RemoteID, _To.m_RemoteID, _Context);
		CppConvert(_From.m_ParentSDKID, _To.m_ParentSDKID, _Context);
...
public:
	static void Convert(NInternal_C::HPMResourceProperties const &_From, HPMResourceProperties &_To, CCppConvertContext &_Context)
	{
		...
		CppConvertReverse(_From.m_SDKSyncMethod, _To.m_SDKSyncMethod, _Context);
		...
		CppConvertReverse(_From.m_ParentSDKID, _To.m_ParentSDKID, _Context);
...
public:
	...
	static void Convert(HPMProjectCustomColumnAncestryEntry const &_From, NInternal_C::HPMProjectCustomColumnAncestryEntry &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_Hash, _To.m_Hash, _Context);
		CppConvert(_From.m_UsedUntil, _To.m_UsedUntil, _Context);
	}
};
template <>
class TCCppConvertReverse<NInternal_C::HPMProjectCustomColumnAncestryEntry, HPMProjectCustomColumnAncestryEntry>
{
public:
	static void Convert(NInternal_C::HPMProjectCustomColumnAncestryEntry const &_From, HPMProjectCustomColumnAncestryEntry &_To, CCppConvertContext &_Context)
	{
		CppConvertReverse(_From.m_Hash, _To.m_Hash, _Context);
		CppConvertReverse(_From.m_UsedUntil, _To.m_UsedUntil, _Context);
	}
};

template <>
class TCCppConvert<HPMProjectCustomColumnAncestry, NInternal_C::HPMProjectCustomColumnAncestry>
{
public:
	class CLocal : public CCppConvertContext::CLocalData
	{
	public:
		std::vector<NInternal_C::HPMProjectCustomColumnAncestryEntry> m_Ancestors;
	};
	
	static void Convert(HPMProjectCustomColumnAncestry const &_From, NInternal_C::HPMProjectCustomColumnAncestry &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		{
			size_t nMembers = _From.m_Ancestors.size();
			pLocal->m_Ancestors.resize(nMembers);
			_To.m_nAncestors = (unsigned int)nMembers;
			if (nMembers)
				_To.m_pAncestors = &(*pLocal->m_Ancestors.begin());
			else
				_To.m_pAncestors = 0;
			for (size_t i = 0; i < nMembers; ++i)
			{
				CppConvert(_From.m_Ancestors[i], pLocal->m_Ancestors[i], _Context);
			}
		}
	}
};
template <>
class TCCppConvertReverse<NInternal_C::HPMProjectCustomColumnAncestry, HPMProjectCustomColumnAncestry>
{
public:
	static void Convert(NInternal_C::HPMProjectCustomColumnAncestry const &_From, HPMProjectCustomColumnAncestry &_To, CCppConvertContext &_Context)
	{
		{
			size_t nMembers = _From.m_nAncestors;
			_To.m_Ancestors.resize(nMembers);
			for (size_t i = 0; i < nMembers; ++i)
			{
				CppConvertReverse(_From.m_pAncestors[i], _To.m_Ancestors[i], _Context);
			}
		}
	}
};
...
public:
	...
	public:
		...
		std::vector<NInternal_C::HPMColumn> m_QAItemSettingsColumns;
		std::vector<NInternal_C::HPMColumn> m_QAItemSettingsColumnsOrder;
	};
	...
	static void Convert(HPMProjectViewPreset const &_From, NInternal_C::HPMProjectViewPreset &_To, CCppConvertContext &_Context)
	{
		...
		{
			size_t nMembers = _From.m_QAItemSettingsColumns.size();
			pLocal->m_QAItemSettingsColumns.resize(nMembers);
			_To.m_nQAItemSettingsColumns = (unsigned int)nMembers;
			if (nMembers)
				_To.m_pQAItemSettingsColumns = &(*pLocal->m_QAItemSettingsColumns.begin());
			else
				_To.m_pQAItemSettingsColumns = 0;
			for (size_t i = 0; i < nMembers; ++i)
			{
				CppConvert(_From.m_QAItemSettingsColumns[i], pLocal->m_QAItemSettingsColumns[i], _Context);
			}
		}
		{
			size_t nMembers = _From.m_QAItemSettingsColumnsOrder.size();
			pLocal->m_QAItemSettingsColumnsOrder.resize(nMembers);
			_To.m_nQAItemSettingsColumnsOrder = (unsigned int)nMembers;
			if (nMembers)
				_To.m_pQAItemSettingsColumnsOrder = &(*pLocal->m_QAItemSettingsColumnsOrder.begin());
			else
				_To.m_pQAItemSettingsColumnsOrder = 0;
			for (size_t i = 0; i < nMembers; ++i)
			{
				CppConvert(_From.m_QAItemSettingsColumnsOrder[i], pLocal->m_QAItemSettingsColumnsOrder[i], _Context);
			}
		}
...
public:
	static void Convert(NInternal_C::HPMProjectViewPreset const &_From, HPMProjectViewPreset &_To, CCppConvertContext &_Context)
	{
		...
		{
			size_t nMembers = _From.m_nQAItemSettingsColumns;
			_To.m_QAItemSettingsColumns.resize(nMembers);
			for (size_t i = 0; i < nMembers; ++i)
			{
				CppConvertReverse(_From.m_pQAItemSettingsColumns[i], _To.m_QAItemSettingsColumns[i], _Context);
			}
		}
		{
			size_t nMembers = _From.m_nQAItemSettingsColumnsOrder;
			_To.m_QAItemSettingsColumnsOrder.resize(nMembers);
			for (size_t i = 0; i < nMembers; ++i)
			{
				CppConvertReverse(_From.m_pQAItemSettingsColumnsOrder[i], _To.m_QAItemSettingsColumnsOrder[i], _Context);
			}
		}
...
public:
	...
	static void Convert(HPMTaskWorkRemainingHistory const &_From, NInternal_C::HPMTaskWorkRemainingHistory &_To, CCppConvertContext &_Context)
	{
		CLocal *pLocal = new CLocal;
		_Context.InsertLocalData(pLocal);
		CppConvert(_From.m_bHaveSetData, _To.m_bHaveSetData, _Context);
		{
...
public:
	...
	{
		CppConvertReverse(_From.m_bHaveSetData, _To.m_bHaveSetData, _Context);
		{
