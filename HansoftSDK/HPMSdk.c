...
static char const*g_HPMExportedFunctions[] = {
	...
	"HPMSdk_ProjectGetCustomColumnAncestry",
	...
	"HPMSdk_ProjectSetBugReportResources",
	"HPMSdk_ProjectGetBugReportResources",
	"HPMSdk_ProjectSetDefaultQAWorkflow",
	...
	"HPMSdk_TaskSetEpicFlag",
	"HPMSdk_TaskGetEpicFlag",
	"HPMSdk_TaskSetLastUpdatedTime",
	"HPMSdk_TaskGetLastUpdatedTime",
	"HPMSdk_TaskSetLastUpdatedBy",
	"HPMSdk_TaskGetLastUpdatedBy",
	...
	"HPMSdk_TaskGetOriginallyCreatedOnTime",
	...
	"HPMSdk_VariantDecode_HPMProjectCustomColumnAncestry",
	...
	"HPMSdk_DashboardPageEnum",
	"HPMSdk_DashboardPageGetName",
	"HPMSdk_DashboardPageSetName",
	"HPMSdk_DashboardPageGetTheme",
	"HPMSdk_DashboardPageSetTheme",
	"HPMSdk_DashboardThemeEnum",
	"HPMSdk_DashboardPageGetSharedToWithViewingRights",
	"HPMSdk_DashboardPageSetSharedToWithViewingRights",
	"HPMSdk_DashboardPageGetSharedToWithEditingRights",
	"HPMSdk_DashboardPageSetSharedToWithEditingRights",
	"HPMSdk_DashboardPageDelete",
	"HPMSdk_DashboardPageCreate",
	"HPMSdk_DashboardPageIsPersonal",
	"HPMSdk_DashboardPageGetCreatedBy",
	"HPMSdk_DashboardPageGetLayout",
	"HPMSdk_DashboardPageSetLayout",

	"HPMSdk_DashboardChartEnum",
	"HPMSdk_DashboardChartCreate",
	"HPMSdk_DashboardChartDelete",
	"HPMSdk_DashboardChartSetName",
	"HPMSdk_DashboardChartSetPresentationConfig",
	"HPMSdk_DashboardChartSetComputationConfig",
	
	"HPMSdk_DashboardChartGetName",
	"HPMSdk_DashboardChartGetPageID",
	"HPMSdk_DashboardChartGetComputationConfig",
	"HPMSdk_DashboardChartGetPresentationConfig",
	"HPMSdk_DashboardChartGetHistoricComputationConfigs",
	"HPMSdk_DashboardChartGetLastSampledHistoricComputationConfig",
	"HPMSdk_DashboardUtilGetMeasureAutoName",
	"HPMSdk_DashboardUtilGetFilterAutoName",
	"HPMSdk_DashboardUtilColumnCanBeUsedForDimension",
	"HPMSdk_DashboardUtilIsDimensionValidForResource",
	"HPMSdk_DashboardUtilIsMeasureValidForResource",
	"HPMSdk_DashboardUtilIsFilterValidForResource",
	"HPMSdk_DashboardUtilIsComputationConfigValidForResource",

	"HPMSdk_DashboardSubscribeToChart",
	"HPMSdk_DashboardSubscriptionGetLastResultSetAsString",
	"HPMSdk_DashboardSubscriptionGetLastResultSet",
...
const char *HPMErrorToStr(HPMInt32 _Error)
{
	...
	case EHPMError_InvalidDashboardPageLayout: return "The provided dashboard page layout is invalid. Ensure the number of columns matches the specified layout type.";
	case EHPMError_InvalidDashboardConfiguration: return "The dashboard configuration was invalid. Additional information might be available through UtilGetLastErrorDescription.";
	case EHPMError_UserNotMemberOfProject: return "The SDK user running the command is not member of the project that the command requested.";
	case EHPMError_DefaultQAWorkflowCannotBeDeleted: return "The default QA workflow cannot be deleted.";
	case EHPMError_DefaultQAWorkflowMustBeVisibleInQA: return "The default QA workflow must be visible in the QA section.";
	}
