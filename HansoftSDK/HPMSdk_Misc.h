...
enum EHPMStatisticsField
{
	...
	EHPMStatisticsField_ItemStatus,							// Item status statistics. Deprecated. Not statistics sampled from Hansoft 8.3.
	EHPMStatisticsField_Severity,							// Severity statistics. Deprecated. Not statistics sampled from Hansoft 8.3.
	EHPMStatisticsField_BugStatus,							// QA Bug status statistics. Deprecated. Not statistics sampled from Hansoft 8.3.
	EHPMStatisticsField_CompletedAndInCompletedDays,		// Statistics about complete and incomplete working days. Deprecated. Not statistics sampled from Hansoft 8.3.
	EHPMStatisticsField_BudgetedWorkEarnedValue,			// Budgeted work earned value statistics. Deprecated. Not statistics sampled from Hansoft 8.3.
	EHPMStatisticsField_ComplexityPoints,					// Complexity point statistics.
	EHPMStatisticsField_Priority,							// Priority statistics. Deprecated. Not statistics sampled from Hansoft 8.3.
	EHPMStatisticsField_Risk,								// Risk statistics. Deprecated. Not statistics sampled from Hansoft 8.3.
	EHPMStatisticsField_Confidence,							// Confidence statistics. Deprecated. Not statistics sampled from Hansoft 8.3.
	EHPMStatisticsField_CustomColumn,						// Custom column statistics. Deprecated. Not statistics sampled from Hansoft 8.3.
	EHPMStatisticsField_CustomStatisticsSampler,			// The field is a custom statistics sampler Deprecated. Not statistics sampled from Hansoft 8.3.
	EHPMStatisticsField_PipelineTasksBuildupAndBurndown,	// Pipeline tasks buildup and burndown statistics. Deprecated. Not statistics sampled from Hansoft 8.3.
	EHPMStatisticsField_RecordedStatisticsOnDate,			// Recorded statistics on specified date. Deprecated. Not statistics sampled from Hansoft 8.3.
...
enum EHPMFindCriteriaDataType
{
	...
	EHPMFindCriteriaDataType_CustomQueryString,			// The criteria data condition is a custom query string.
	EHPMFindCriteriaDataType_DropListWithDate,			// The criteria data condition is a list with dates.
	EHPMFindCriteriaDataType_DropListWithDropList,		// The criteria data condition is a list with a list.
};
...
|		EHPMProjectField_CustomColumnAncestry:					Use @{VariantDecode_HPMProjectCustomColumnAncestry}.				|
...
|																									|
|	Managed:			RetNotYetAvailable ExtendedError											|
|																									|
\*_________________________________________________________________________________________________*/
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMUInt32}.											|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMInt64}.											|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMUInt64}.											|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMFP32}.												|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMFP64}.												|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMUniqueID}.											|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMString}.											|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMTaskLinkedToMilestones}.							|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMResourceDefinitionList}.							|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMTaskSprintAllocatedResources}.						|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMTaskResourceAllocation}.							|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMStatisticsMultiFrequency}.							|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMStatisticsCustomStatisticsFrequency}.				|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMTaskAttachedDocuments}.							|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMTaskVacationOptions}.								|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMTaskCommentsOptions}.								|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMTaskLinkedTo}.										|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMTaskSprintResourceAllocation}.						|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMDataHistoryTaskCreated}.							|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMDataHistoryTaskRestoredFromHistory}.				|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMDataHistoryTaskMoved}.								|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMDataHistoryTaskRenameCustomColumn}.				|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMDataHistoryTaskProxyCreated}.						|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMDataHistoryTaskProxyDeleted}.						|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMTaskTimeZones}.									|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMChatMessage}.										|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMProjectCustomColumns}.								|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMProjectCustomColumnsColumn}.						|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMProjectCustomColumnAncestry}.						|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
\*_________________________________________________________________________________________________*/
typedef HPMError (DHPMSdkCallingConvention *HPMFunctionVariantDecode_HPMProjectCustomColumnAncestry)(void *_pSession,								// [in] A connected session. See @{SessionOpen}.
																									 const HPMVariantData *_pVariantData,			// [in] Pointer to the variant data to decode. See @{HPMVariantData}.
																									 const HPMProjectCustomColumnAncestry **_pData	// [out] Pointer to a pointer of a @{HPMProjectCustomColumnAncestry} object, representing the returned data.
																									);

/*¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯*\
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMProjectWorkflowSettings}.							|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMHolidays}.											|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMWorkingDays}.										|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMCustomWorkingDays}.								|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMWorkingHours}.								|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMCustomWorkingHours}.								|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMProjectDefaultColumns}.							|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMUntranslatedString}.								|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
\*_________________________________________________________________________________________________*/
typedef HPMError (DHPMSdkCallingConvention *HPMFunctionVariantDecode_HPMUntranslatedString)(	void *_pSession,						// [in] A connected session. See @{SessionOpen}.
																								HPMVariantData const *_pVariantData,	// [in] Pointer to the variant data to decode. See @{HPMVariantData}.
																								HPMUntranslatedString const **_pData	// [out] Pointer to a pointer of a @{HPMUntranslatedString} object, representing the returned data.
																							);

/*¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯*\
|	Function:																						|
|																									|
|	Description:		Get variant data as @{HPMBinaryBuffer}.										|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}. If the data cannot be converted	|
|						to the requested format @{EHPMError}_ConversionNotSupported is returned.	|
|																									|
...
\*_________________________________________________________________________________________________*/
typedef HPMError (DHPMSdkCallingConvention *HPMFunctionVariantDecode_HPMBinaryBuffer)(	void *_pSession,						// [in] A connected session. See @{SessionOpen}.
																						HPMVariantData const *_pVariantData,	// [in] Pointer to the variant data to decode. See @{HPMVariantData}.
																						HPMBinaryBuffer const **_pData			// [out] Pointer to a pointer of a @{HPMBinaryBuffer} object, representing the returned data.
																					);
...
\*_________________________________________________________________________________________________*/
typedef HPMError(DHPMSdkCallingConvention *HPMFunctionVariantDecode_ProjectBugReportResources)(void *_pSession,								// [in] A connected session. See @{SessionOpen}.
																								HPMVariantData const *_pVariantData,		// [in] Pointer to the variant data to decode. See @{HPMVariantData}.
