...
{    
	...
	HPMFunctionProjectGetCustomColumnAncestry ProjectGetCustomColumnAncestry;															// Gets a ancestry for a custom column. See @{HPMFunctionProjectGetCustomColumnAncestry}. 
	...
	HPMFunctionProjectSetBugReportResources ProjectSetBugReportResources;																// Sets resources that can report bugs. See @{HPMFunctionProjectSetBugReportResources}.
	HPMFunctionProjectGetBugReportResources ProjectGetBugReportResources;																// Gets resources that can report bugs. See @{HPMFunctionProjectGetBugReportResources}.
	HPMFunctionProjectSetDefaultQAWorkflow ProjectSetDefaultQAWorkflow;																	// Sets the default QA workflow. See @{HPMFunctionProjectSetDefaultQAWorkflow}.
	...
	HPMFunctionTaskSetEpicFlag TaskSetEpicFlag;																							// Sets the epic flag of a task. See @{HPMFunctionTaskSetEpicFlag}.
	HPMFunctionTaskGetEpicFlag TaskGetEpicFlag;																							// Gets the epic flag of a task. See @{HPMFunctionTaskGetEpicFlag}.
	...
	HPMFunctionTaskSetLastUpdatedBy TaskSetLastUpdatedBy;																				// Sets the last user that updated a task. See @{HPMFunctionTaskSetLastUpdatedBy}.
	HPMFunctionTaskGetLastUpdatedBy TaskGetLastUpdatedBy;																				// Gets the last user that updated a task. See @{HPMFunctionTaskSetLastUpdatedBy}.
	...
	HPMFunctionTaskGetOriginallyCreatedOnTime TaskGetOriginallyCreatedOnTime;															// Returns the time the task was created on. See @{TaskGetOriginallyCreatedOnTime}.
	...
	HPMFunctionVariantDecode_HPMProjectCustomColumnAncestry VariantDecode_HPMProjectCustomColumnAncestry;								// Decodes variant data to the HPMProjectCustomColumnAncestry format. See @{HPMFunctionVariantDecode_HPMProjectCustomColumnAncestry}.
	...
	HPMFunctionDashboardPageEnum DashboardPageEnum;																						// Enumerates dashboard page IDs in a database. See @{HPMFunctionDashboardPageEnum}.
	HPMFunctionDashboardPageGetName DashboardPageGetName;																				// Gets the name of a page. See @{HPMFunctionDashboardPageGetName}.
	HPMFunctionDashboardPageSetName DashboardPageSetName;																				// Sets the name of a page. See @{HPMFunctionDashboardPageSetName}.
	HPMFunctionDashboardPageGetTheme DashboardPageGetTheme;																				// Gets the theme of a page. See @{HPMFunctionDashboardPageGetTheme}.
	HPMFunctionDashboardPageSetTheme DashboardPageSetTheme;																				// Sets the theme of a page. See @{HPMFunctionDashboardPageSetTheme}.
	HPMFunctionDashboardThemeEnum DashboardThemeEnum;																					// Lists the available dashboard themes. See @{HPMFunctionDashboardThemeEnum}.
	HPMFunctionDashboardPageGetSharedToWithViewingRights DashboardPageGetSharedToWithViewingRights;										// Gets the resources that the page is shared to with viewing rights. See @{HPMFunctionDashboardPageGetSharedToWithViewingRights}.
	HPMFunctionDashboardPageSetSharedToWithViewingRights DashboardPageSetSharedToWithViewingRights;										// Sets the resources that the page is shared to with viewing rights. See @{HPMFunctionDashboardPageSetSharedToWithViewingRights}.
	HPMFunctionDashboardPageGetSharedToWithEditingRights DashboardPageGetSharedToWithEditingRights;										// Gets the resources that the page is shared to with editing rights. See @{HPMFunctionDashboardPageGetSharedToWithEditingRights}.
	HPMFunctionDashboardPageSetSharedToWithEditingRights DashboardPageSetSharedToWithEditingRights;										// Sets the resources that the page is shared to with editing rights. See @{HPMFunctionDashboardPageSetSharedToWithEditingRights}.
	HPMFunctionDashboardPageDelete DashboardPageDelete;																					// Deletes the page with the given unique identifier. See @{HPMFunctionDashboardPageDelete}.
	HPMFunctionDashboardPageCreate DashboardPageCreate;																					// Creates a new page. See @{HPMFunctionDashboardPageCreate}.
	HPMFunctionDashboardPageIsPersonal DashboardPageIsPersonal;																			// Gets whether the page is personal to a resource. See @{HPMFunctionDashboardPageIsPersonal}.
	HPMFunctionDashboardPageGetCreatedBy DashboardPageGetCreatedBy;																		// Gets the unique identifier of the resource that created the page. See @{HPMFunctionDashboardPageGetCreatedBy}.
	HPMFunctionDashboardPageGetLayout DashboardPageGetLayout;																			// Gets the layout of a page. See @{HPMFunctionDashboardPageGetLayout}.
	HPMFunctionDashboardPageSetLayout DashboardPageSetLayout;																			// Sets the layout of a page. See @{HPMFunctionDashboardPageSetLayout}.

	HPMFunctionDashboardChartEnum DashboardChartEnum;																					// Enumerates chart IDs on a dashboard page. See @{HPMFunctionDashboardChartEnum}.
	HPMFunctionDashboardChartCreate DashboardChartCreate;																				// TBD. See @{HPMFunctionDashboardChartCreate}.
	HPMFunctionDashboardChartDelete DashboardChartDelete;																				// TBD. See @{HPMFunctionDashboardChartDelete}.
	HPMFunctionDashboardChartSetName DashboardChartSetName;																				// TBD. See @{HPMFunctionDashboardChartSetName}.
	HPMFunctionDashboardChartSetPresentationConfig DashboardChartSetPresentationConfig;													// TBD. See @{HPMFunctionDashboardChartSetPresentationConfig}.
	HPMFunctionDashboardChartSetComputationConfig DashboardChartSetComputationConfig;													// TBD. See @{HPMFunctionDashboardChartSetComputationConfig}.
	
	HPMFunctionDashboardChartGetName DashboardChartGetName;																				// TBD. See @{HPMFunctionDashboardChartGetName}.
	HPMFunctionDashboardChartGetPageID DashboardChartGetPageID;																			// TBD. See @{HPMFunctionDashboardChartGetPageID}.
	HPMFunctionDashboardChartGetComputationConfig DashboardChartGetComputationConfig;													// TBD. See @{HPMFunctionDashboardChartGetComputationConfig}.
	HPMFunctionDashboardChartGetPresentationConfig DashboardChartGetPresentationConfig;													// TBD. See @{HPMFunctionDashboardChartGetPresentationConfig}.
	HPMFunctionDashboardChartGetHistoricComputationConfigs DashboardChartGetHistoricComputationConfigs;									// TBD. See @{HPMFunctionDashboardChartGetHistoricComputationConfigs}.
	HPMFunctionDashboardChartGetLastSampledHistoricComputationConfig DashboardChartGetLastSampledHistoricComputationConfig;				// TBD. See @{HPMFunctionDashboardChartGetLastSampledHistoricComputationConfig}.
	HPMFunctionDashboardUtilGetMeasureAutoName DashboardUtilGetMeasureAutoName;															// TBD. See @{HPMFunctionDashboardUtilGetMeasureAutoName}.
	HPMFunctionDashboardUtilGetFilterAutoName DashboardUtilGetFilterAutoName;															// TBD. See @{HPMFunctionDashboardUtilGetFilterAutoName}.
	HPMFunctionDashboardUtilColumnCanBeUsedForDimension DashboardUtilColumnCanBeUsedForDimension;										// TBD. See @{HPMFunctionDashboardUtilColumnCanBeUsedForDimension}.
	HPMFunctionDashboardUtilIsDimensionValidForResource DashboardUtilIsDimensionValidForResource;										// TBD. See @{HPMFunctionDashboardUtilIsDimensionValidForResource}.
	HPMFunctionDashboardUtilIsMeasureValidForResource DashboardUtilIsMeasureValidForResource;											// TBD. See @{HPMFunctionDashboardUtilIsMeasureValidForResource}.
	HPMFunctionDashboardUtilIsFilterValidForResource DashboardUtilIsFilterValidForResource;												// TBD. See @{HPMFunctionDashboardUtilIsFilterValidForResource}.
	HPMFunctionDashboardUtilIsComputationConfigValidForResource DashboardUtilIsComputationConfigValidForResource;						// TBD. See @{HPMFunctionDashboardUtilIsComputationConfigValidForResource}.

	HPMFunctionDashboardSubscribeToChart DashboardSubscribeToChart;																		// Subscribes to a chart. Chart data will be received asynchronously. See @{HPMFunctionDashboardSubscribeToChart}.
	HPMFunctionDashboardSubscriptionGetLastResultSetAsString DashboardSubscriptionGetLastResultSetAsString;								// Decodes dashboard subscription data to result set as a @{HPMString}. See @{HPMFunctionDashboardSubscriptionGetLastResultSetAsString}.
	HPMFunctionDashboardSubscriptionGetLastResultSet DashboardSubscriptionGetLastResultSet;												// Decodes dashboard subscription data to result set as a @{HPMDashboardChartResultSet}. See @{HPMFunctionDashboardSubscriptionGetLastResultSet}.
