...
|																								|
|	Location:		/Hansoft PM SDK/Reference/10 - Notifications								|
|																								|
|	Section:		Reference																	|
|																								|
|	History:																					|
...
enum EHPMChangeCallbackOperation
{
	...
	// Version 8.1 Changes
	EHPMChangeCallbackOperation_DashboardChartReceive,							// Dashboard chart subscription notification. @{HPMChangeCallbackInfo}::m_pCallbackData should be cast to @{HPMChangeCallbackData_DashboardChartReceive}.
	EHPMChangeCallbackOperation_DashboardChartCreate,							// A dashboard chart was created. @{HPMChangeCallbackInfo}::m_pCallbackData should be cast to @{HPMChangeCallbackData_DashboardChartCreate}.
	EHPMChangeCallbackOperation_DashboardComputationConfigurationChange,		// A dashboard computation configuration was changed. @{HPMChangeCallbackInfo}::m_pCallbackData should be cast to @{HPMChangeCallbackData_DashboardComputationConfigurationChange}.
	EHPMChangeCallbackOperation_DashboardPresentationConfigurationChange,		// A dashboard presentation configuration was changed. @{HPMChangeCallbackInfo}::m_pCallbackData should be cast to @{HPMChangeCallbackData_DashboardPresentationConfigurationChange}.
	EHPMChangeCallbackOperation_DashboardChartDelete,							// A dashboard chart was deleted. @{HPMChangeCallbackInfo}::m_pCallbackData should be cast to @{HPMChangeCallbackData_DashboardChartDelete}.
	EHPMChangeCallbackOperation_DashboardChartNameChange,						// A dashboard chart name was changed. @{HPMChangeCallbackInfo}::m_pCallbackData should be cast to @{HPMChangeCallbackData_DashboardChartNameChange}.
	EHPMChangeCallbackOperation_DashboardPageCreate,							// A dashboard page was created. @{HPMChangeCallbackInfo}::m_pCallbackData should be cast to @{HPMChangeCallbackData_DashboardPageCreate}.
	EHPMChangeCallbackOperation_DashboardPageNameChange,						// A dashboard page name was changed. @{HPMChangeCallbackInfo}::m_pCallbackData should be cast to @{HPMChangeCallbackData_DashboardPageNameChange}.
	EHPMChangeCallbackOperation_DashboardThemeChange,							// A dashboard theme was changed. @{HPMChangeCallbackInfo}::m_pCallbackData should be cast to @{HPMChangeCallbackData_DashboardThemeChange}.
	EHPMChangeCallbackOperation_DashboardPageLayoutChange,						// A dashboard page layout was changed. @{HPMChangeCallbackInfo}::m_pCallbackData should be cast to @{HPMChangeCallbackData_DashboardPageLayoutChange}.
	EHPMChangeCallbackOperation_DashboardPageSharedToWithViewingRightsChange,	// A dashboard page viewing rights was changed. @{HPMChangeCallbackInfo}::m_pCallbackData should be cast to @{HPMChangeCallbackData_DashboardPageSharedToWithViewingRightsChange}.
	EHPMChangeCallbackOperation_DashboardPageSharedToWithEditingRightsChange,	// A dashboard page editing rights was changed. @{HPMChangeCallbackInfo}::m_pCallbackData should be cast to @{HPMChangeCallbackData_DashboardPageSharedToWithEditingRightsChange}.
	EHPMChangeCallbackOperation_DashboardPageDelete,							// A dashboard page was deleted. @{HPMChangeCallbackInfo}::m_pCallbackData should be cast to @{HPMChangeCallbackData_DashboardPageDelete}.

	// Version 8.3 Changes
	EHPMChangeCallbackOperation_UserNotMemberOfProject,							// The SDK user running the command is not member of the project that that the command requested. @{HPMChangeCallbackInfo}::m_pCallbackData should be cast to @{HPMChangeCallbackData_UserNotMemberOfProject}.

	// Version 8.4 Changes										
	EHPMChangeCallbackOperation_ProjectBugReportResourcesChange,				// The resources that can report bugs in a project changed. @{HPMChangeCallbackInfo}::m_pCallbackData should be cast to @{HPMChangeCallbackData_ProjectBugReportResourcesChange}.
	EHPMChangeCallbackOperation_ProjectDefaultQAWorkflowChange,					// The default QA workflow changed. @{HPMChangeCallbackInfo}::m_pCallbackData should be cast to @{HPMChangeCallbackData_ProjectDefaultQAWorkflowChange}.
...
typedef struct HPMChangeCallbackData_ProjectWorkflowChange
{
	...
	HPMInt32 m_bValidChange;						// Set to 1 if the change succeeded, 0 otherwise.
...
|	Description:		Callback data type for @{HPMChangeCallbackInfo}::m_pCallbackData			|
|						when @{HPMChangeCallbackInfo}::m_Operation is set to						|
|						@{EHPMChangeCallbackOperation}_DashboardChartReceive.						|
|																									|
|	See Also:			@{EHPMChangeCallbackOperation}, @{HPMChangeCallbackInfo}					|
|																									|
|	Location:			Structures																	|
...
|	Index:				!name																		|
\*_________________________________________________________________________________________________*/
typedef struct HPMChangeCallbackData_DashboardChartReceive
{
	HPMUniqueID m_ChartID;										// The unique identifier of the subscribed chart.
	HPMUInt64 m_FirstSampledAt;									// Time of the first sample taken for sampled data. Invalid if the chart is not sampled. Expressed as the number of microseconds since 1970 UTC.
	HPMUInt64 m_LastSampledAt;									// Time of the last sample taken for sampled data. Invalid if the chart is not sampled. Expressed as the number of microseconds since 1970 UTC.
...
|	Description:		Callback data type for @{HPMChangeCallbackInfo}::m_pCallbackData			|
|						when @{HPMChangeCallbackInfo}::m_Operation is set to						|
|						@{EHPMChangeCallbackOperation}_DashboardChartCreate.						|
|																									|
|	See Also:			@{EHPMChangeCallbackOperation}, @{HPMChangeCallbackInfo}					|
|																									|
|	Location:			Structures																	|
...
|	Index:				!name																		|
\*_________________________________________________________________________________________________*/
typedef struct HPMChangeCallbackData_DashboardChartCreate
{
	HPMInt32 m_bChangeInitiatedFromThisSession;		// Set to 1 if this change in the database was the result of an operation that was initiated from this session.
	HPMUniqueID m_ChangedByResourceID;				// The unique identifier of the resource that initiated the change.
	HPMUniqueID m_ChangedByImpersonatedResourceID;	// The unique identifier of the impersonated resource that initiated the change.
	HPMUniqueID m_ChartID;							// The unique identifier of the created chart.
	HPMUniqueID m_LocalObjectID;					// The local identifier optionally sent in with @{DashboardChartCreate}.
	HPMUniqueID m_PageID;							// The unique identifier of the page the chart was created on.
...
|	Description:		Callback data type for @{HPMChangeCallbackInfo}::m_pCallbackData			|
|						when @{HPMChangeCallbackInfo}::m_Operation is set to						|
|						@{EHPMChangeCallbackOperation}_DashboardComputationConfigurationChange.		|
|																									|
|	See Also:			@{EHPMChangeCallbackOperation}, @{HPMChangeCallbackInfo}					|
|																									|
|	Location:			Structures																	|
...
|	Index:				!name																		|
\*_________________________________________________________________________________________________*/
typedef struct HPMChangeCallbackData_DashboardComputationConfigurationChange
{
	HPMInt32 m_bChangeInitiatedFromThisSession;		// Set to 1 if this change in the database was the result of an operation that was initiated from this session.
	HPMUniqueID m_ChangedByResourceID;				// The unique identifier of the resource that initiated the change.
	HPMUniqueID m_ChangedByImpersonatedResourceID;	// The unique identifier of the impersonated resource that initiated the change.
	HPMUniqueID m_ChartID;							// The unique identifier of the chart with configuration changes.
...
|	Description:		Callback data type for @{HPMChangeCallbackInfo}::m_pCallbackData			|
|						when @{HPMChangeCallbackInfo}::m_Operation is set to						|
|						@{EHPMChangeCallbackOperation}_DashboardPresentationConfigurationChange.	|
|																									|
|	See Also:			@{EHPMChangeCallbackOperation}, @{HPMChangeCallbackInfo}					|
|																									|
|	Location:			Structures																	|
...
|	Index:				!name																		|
\*_________________________________________________________________________________________________*/
typedef struct HPMChangeCallbackData_DashboardPresentationConfigurationChange
{
	HPMInt32 m_bChangeInitiatedFromThisSession;		// Set to 1 if this change in the database was the result of an operation that was initiated from this session.
	HPMUniqueID m_ChangedByResourceID;				// The unique identifier of the resource that initiated the change.
	HPMUniqueID m_ChangedByImpersonatedResourceID;	// The unique identifier of the impersonated resource that initiated the change.
...
|	Description:		Callback data type for @{HPMChangeCallbackInfo}::m_pCallbackData			|
|						when @{HPMChangeCallbackInfo}::m_Operation is set to						|
|						@{EHPMChangeCallbackOperation}_DashboardChartDelete.						|
|																									|
|	See Also:			@{EHPMChangeCallbackOperation}, @{HPMChangeCallbackInfo}					|
|																									|
|	Location:			Structures																	|
...
|	Index:				!name																		|
\*_________________________________________________________________________________________________*/
typedef struct HPMChangeCallbackData_DashboardChartDelete
{
	HPMInt32 m_bChangeInitiatedFromThisSession;		// Set to 1 if this change in the database was the result of an operation that was initiated from this session.
	HPMUniqueID m_ChangedByResourceID;				// The unique identifier of the resource that initiated the change.
	HPMUniqueID m_ChangedByImpersonatedResourceID;	// The unique identifier of the impersonated resource that initiated the change.
	HPMUniqueID m_ChartID;							// The unique identifier of the chart that was deleted.
	HPMUniqueID m_PageID;							// The unique identifier of the page the deleted chart was deleted on.
...
|	Description:		Callback data type for @{HPMChangeCallbackInfo}::m_pCallbackData			|
|						when @{HPMChangeCallbackInfo}::m_Operation is set to						|
|						@{EHPMChangeCallbackOperation}_DashboardChartNameChange.					|
|																									|
|	See Also:			@{EHPMChangeCallbackOperation}, @{HPMChangeCallbackInfo}					|
|																									|
|	Location:			Structures																	|
...
|	Index:				!name																		|
\*_________________________________________________________________________________________________*/
typedef struct HPMChangeCallbackData_DashboardChartNameChange
{
	HPMInt32 m_bChangeInitiatedFromThisSession;		// Set to 1 if this change in the database was the result of an operation that was initiated from this session.
	HPMUniqueID m_ChangedByResourceID;				// The unique identifier of the resource that initiated the change.
	HPMUniqueID m_ChangedByImpersonatedResourceID;	// The unique identifier of the impersonated resource that initiated the change.
	HPMUniqueID m_ChartID;							// The unique identifier of the chart whose name was changed.
...
|	Description:		Callback data type for @{HPMChangeCallbackInfo}::m_pCallbackData			|
|						when @{HPMChangeCallbackInfo}::m_Operation is set to						|
|						@{EHPMChangeCallbackOperation}_DashboardPageCreate.							|
|																									|
|	See Also:			@{EHPMChangeCallbackOperation}, @{HPMChangeCallbackInfo}					|
|																									|
|	Location:			Structures																	|
...
|	Index:				!name																		|
\*_________________________________________________________________________________________________*/
typedef struct HPMChangeCallbackData_DashboardPageCreate
{
	HPMInt32 m_bChangeInitiatedFromThisSession;		// Set to 1 if this change in the database was the result of an operation that was initiated from this session.
	HPMUniqueID m_ChangedByResourceID;				// The unique identifier of the resource that initiated the change.
	HPMUniqueID m_ChangedByImpersonatedResourceID;	// The unique identifier of the impersonated resource that initiated the change.
	HPMUniqueID m_PageID;							// The unique identifier of the created page.
	HPMUniqueID m_LocalObjectID;					// The local identifier optionally sent in with @{DashboardPageCreate}.
	HPMUniqueID m_ResourceID;						// The unique identifier of the resource that created the page.
...
|	Description:		Callback data type for @{HPMChangeCallbackInfo}::m_pCallbackData			|
|						when @{HPMChangeCallbackInfo}::m_Operation is set to						|
|						@{EHPMChangeCallbackOperation}_DashboardPageNameChange.						|
|																									|
|	See Also:			@{EHPMChangeCallbackOperation}, @{HPMChangeCallbackInfo}					|
|																									|
|	Location:			Structures																	|
...
|	Index:				!name																		|
\*_________________________________________________________________________________________________*/
typedef struct HPMChangeCallbackData_DashboardPageNameChange
{
	HPMInt32 m_bChangeInitiatedFromThisSession;		// Set to 1 if this change in the database was the result of an operation that was initiated from this session.
	HPMUniqueID m_ChangedByResourceID;				// The unique identifier of the resource that initiated the change.
	HPMUniqueID m_ChangedByImpersonatedResourceID;	// The unique identifier of the impersonated resource that initiated the change.
	HPMUniqueID m_PageID;							// The unique identifier of the page whose name was changed.
...
|	Description:		Callback data type for @{HPMChangeCallbackInfo}::m_pCallbackData			|
|						when @{HPMChangeCallbackInfo}::m_Operation is set to						|
|						@{EHPMChangeCallbackOperation}_DashboardThemeChange.						|
|																									|
|	See Also:			@{EHPMChangeCallbackOperation}, @{HPMChangeCallbackInfo}					|
|																									|
|	Location:			Structures																	|
...
|	Index:				!name																		|
\*_________________________________________________________________________________________________*/
typedef struct HPMChangeCallbackData_DashboardThemeChange
{
	HPMInt32 m_bChangeInitiatedFromThisSession;		// Set to 1 if this change in the database was the result of an operation that was initiated from this session.
	HPMUniqueID m_ChangedByResourceID;				// The unique identifier of the resource that initiated the change.
	HPMUniqueID m_ChangedByImpersonatedResourceID;	// The unique identifier of the impersonated resource that initiated the change.
	HPMUniqueID m_PageID;							// The unique identifier of the page whose theme was changed.
...
|	Description:		Callback data type for @{HPMChangeCallbackInfo}::m_pCallbackData			|
|						when @{HPMChangeCallbackInfo}::m_Operation is set to						|
|						@{EHPMChangeCallbackOperation}_DashboardPageLayoutChange.					|
|																									|
|	See Also:			@{EHPMChangeCallbackOperation}, @{HPMChangeCallbackInfo}					|
|																									|
|	Location:			Structures																	|
...
|	Index:				!name																		|
\*_________________________________________________________________________________________________*/
typedef struct HPMChangeCallbackData_DashboardPageLayoutChange
{
	HPMInt32 m_bChangeInitiatedFromThisSession;		// Set to 1 if this change in the database was the result of an operation that was initiated from this session.
	HPMUniqueID m_ChangedByResourceID;				// The unique identifier of the resource that initiated the change.
	HPMUniqueID m_ChangedByImpersonatedResourceID;	// The unique identifier of the impersonated resource that initiated the change.
	HPMUniqueID m_PageID;							// The unique identifier of the page whose layout was changed.
...
|	Description:		Callback data type for @{HPMChangeCallbackInfo}::m_pCallbackData			|
|						when @{HPMChangeCallbackInfo}::m_Operation is set to						|
|						@{EHPMChangeCallbackOperation}_DashboardPageSharedToWithViewingRightsChange.|
|																									|
|	See Also:			@{EHPMChangeCallbackOperation}, @{HPMChangeCallbackInfo}					|
|																									|
|	Location:			Structures																	|
...
|	Index:				!name																		|
\*_________________________________________________________________________________________________*/
typedef struct HPMChangeCallbackData_DashboardPageSharedToWithViewingRightsChange
{
	HPMInt32 m_bChangeInitiatedFromThisSession;		// Set to 1 if this change in the database was the result of an operation that was initiated from this session.
	HPMUniqueID m_ChangedByResourceID;				// The unique identifier of the resource that initiated the change.
	HPMUniqueID m_ChangedByImpersonatedResourceID;	// The unique identifier of the impersonated resource that initiated the change.
	HPMUniqueID m_PageID;							// The unique identifier of the page whose shared to viewing rights was changed.
...
|	Description:		Callback data type for @{HPMChangeCallbackInfo}::m_pCallbackData			|
|						when @{HPMChangeCallbackInfo}::m_Operation is set to						|
|						@{EHPMChangeCallbackOperation}_DashboardPageSharedToWithEditingRightsChange.|
|																									|
|	See Also:			@{EHPMChangeCallbackOperation}, @{HPMChangeCallbackInfo}					|
|																									|
|	Location:			Structures																	|
...
|	Index:				!name																		|
\*_________________________________________________________________________________________________*/
typedef struct HPMChangeCallbackData_DashboardPageSharedToWithEditingRightsChange
{
	HPMInt32 m_bChangeInitiatedFromThisSession;		// Set to 1 if this change in the database was the result of an operation that was initiated from this session.
	HPMUniqueID m_ChangedByResourceID;				// The unique identifier of the resource that initiated the change.
	HPMUniqueID m_ChangedByImpersonatedResourceID;	// The unique identifier of the impersonated resource that initiated the change.
	HPMUniqueID m_PageID;							// The unique identifier of the page whose shared to editing was changed.
...
|	Description:		Callback data type for @{HPMChangeCallbackInfo}::m_pCallbackData			|
|						when @{HPMChangeCallbackInfo}::m_Operation is set to						|
|						@{EHPMChangeCallbackOperation}_DashboardPageDelete.							|
|																									|
|	See Also:			@{EHPMChangeCallbackOperation}, @{HPMChangeCallbackInfo}					|
|																									|
|	Location:			Structures																	|
...
|	Index:				!name																		|
\*_________________________________________________________________________________________________*/
typedef struct HPMChangeCallbackData_DashboardPageDelete
{
	HPMInt32 m_bChangeInitiatedFromThisSession;		// Set to 1 if this change in the database was the result of an operation that was initiated from this session.
	HPMUniqueID m_ChangedByResourceID;				// The unique identifier of the resource that initiated the change.
	HPMUniqueID m_ChangedByImpersonatedResourceID;	// The unique identifier of the impersonated resource that initiated the change.
	HPMUniqueID m_PageID;							// The unique identifier of the page that was deleted.
...
|	Description:		Callback data type for @{HPMChangeCallbackInfo}::m_pCallbackData			|
|						when @{HPMChangeCallbackInfo}::m_Operation is set to						|
|						@{EHPMChangeCallbackOperation}_UserNotMemberOfProject.						|
|																									|
|	See Also:			@{EHPMChangeCallbackOperation}, @{HPMChangeCallbackInfo}					|
|																									|
|	Location:			Structures																	|
...
|	Index:				!name																		|
\*_________________________________________________________________________________________________*/
typedef struct HPMChangeCallbackData_UserNotMemberOfProject
{
	HPMInt32 m_bChangeInitiatedFromThisSession;			// Set to 1 if this change in the database was the result of an operation that was initiated from this session.
...
|	Description:		Callback data type for @{HPMChangeCallbackInfo}::m_pCallbackData			|
|						when @{HPMChangeCallbackInfo}::m_Operation is set to						|
|						@{EHPMChangeCallbackOperation}_ProjectBugReportResourcesChange.				|
|																									|
|	See Also:			@{EHPMChangeCallbackOperation}, @{HPMChangeCallbackInfo}					|
|																									|
|	Location:			Structures																	|
...
|	Index:				!name																		|
\*_________________________________________________________________________________________________*/
typedef struct HPMChangeCallbackData_ProjectBugReportResourcesChange
{
	HPMInt32 m_bChangeInitiatedFromThisSession;		// Set to 1 if this change in the database was the result of an operation that was initiated from this session.
	HPMUniqueID m_ChangedByResourceID;				// The unique identifier of the resource that initiated the change.
	HPMUniqueID m_ChangedByImpersonatedResourceID;	// The unique identifier of the impersonated resource that initiated the change.
	HPMUniqueID m_ProjectID;						// The unique identifier of the project where the bug reporting resources changed.
...
|	Description:		Callback data type for @{HPMChangeCallbackInfo}::m_pCallbackData			|
|						when @{HPMChangeCallbackInfo}::m_Operation is set to						|
|						@{EHPMChangeCallbackOperation}_ProjectDefaultQAWorkflowChange.				|
|																									|
|	See Also:			@{EHPMChangeCallbackOperation}, @{HPMChangeCallbackInfo}					|
|																									|
|	Location:			Structures																	|
...
|	Index:				!name																		|
\*_________________________________________________________________________________________________*/
typedef struct HPMChangeCallbackData_ProjectDefaultQAWorkflowChange
{
	HPMInt32 m_bChangeInitiatedFromThisSession;		// Set to 1 if this change in the database was the result of an operation that was initiated from this session.
	HPMUniqueID m_ChangedByResourceID;				// The unique identifier of the resource that initiated the change.
	HPMUniqueID m_ChangedByImpersonatedResourceID;	// The unique identifier of the impersonated resource that initiated the change.
	HPMUniqueID m_ProjectID;						// The unique identifier of the project where the default QA worflow changed.
	HPMInt32 m_bValidChange;						// Set to 1 if the change succeeded, 0 otherwise.
...
|	Description:		Callback data type for @{HPMChangeCallbackInfo}::m_pCallbackData			|
|						when @{HPMChangeCallbackInfo}::m_Operation is set to						|
|						@{EHPMChangeCallbackOperation}_SharesUpdate.								|
|																									|
|	See Also:			@{EHPMChangeCallbackOperation}, @{HPMChangeCallbackInfo}					|
|																									|
|	Location:			Structures																	|
...
|	Index:				!name																		|
\*_________________________________________________________________________________________________*/
typedef struct HPMChangeCallbackData_SharesUpdate
{
	HPMInt32 m_bChangeInitiatedFromThisSession;		// Set to 1 if this change in the database was the result of an operation that was initiated from this session.
	HPMUniqueID m_ChangedByResourceID;				// The unique identifier of the resource that initiated the change.
	HPMUniqueID m_ChangedByImpersonatedResourceID;	// The unique identifier of the impersonated resource that initiated the change.
