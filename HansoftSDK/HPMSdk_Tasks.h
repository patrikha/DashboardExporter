...
enum EHPMTaskField
{
	...
	EHPMTaskField_CommentStore,							// SDK internal data comment store. Used: Task history, change callback
	EHPMTaskField_OriginallyCreatedOnTime,				// Originally created on time. Used: Task history, change callback
	EHPMTaskField_EpicFlag,								// Epic flag for a task. Used: Task history, change callback
	EHPMTaskField_LastUpdatedBy,						// The last user that updated a task. Used: Change callback.
};
...
{
	HPMInt32 m_bHaveSetData;							// [default=0] Set to 1 if there exist any data, 0 otherwise.
...
typedef HPMError (DHPMSdkCallingConvention *HPMFunctionTaskSetLastResourceCommentReadTime)(	void *_pSession,			// [in] A connected session. See @{SessionOpen}.
																							...
																							HPMUInt64 _Data				// [in] The time the resource last read comments for a task. Expressed as number of micro seconds since 1970 UTC.
																						);
...
typedef HPMError (DHPMSdkCallingConvention *HPMFunctionTaskGetLastResourceCommentReadTime)(	void *_pSession,			// [in] A connected session. See @{SessionOpen}.
																							...
																							HPMUInt64 *_pData			// [out] Pointer to a variable that will receive the time comments was last read for the task and resource. Expressed as number of micro seconds since 1970 UTC.
																						);
...
|	Function:																						|
|																									|
|	Description:		Sets the epic flag of a task.												|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}.									|
|																									|
|	See Also:			@{HPMSdkFunctions}						 									|
...
|						TaskSetEpicFlag																|
\*_________________________________________________________________________________________________*/
typedef HPMError (DHPMSdkCallingConvention *HPMFunctionTaskSetEpicFlag)(void *_pSession,					// [in] A connected session. See @{SessionOpen}.
																		HPMUniqueID _TaskID,				// [in] The unique identifier of the task to set the epic flag of.
																		HPMInt32 _bData						// [in] The value of the epic flag to set. Can be 0 or 1.
																		);
/*¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯*\
|	Function:																						|
|																									|
|	Description:		Gets the epic flag of a task.												|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}.									|
|																									|
|	See Also:			@{HPMSdkFunctions}															|
...
|						TaskGetEpicFlag																|
\*_________________________________________________________________________________________________*/
typedef HPMError (DHPMSdkCallingConvention *HPMFunctionTaskGetEpicFlag)(void *_pSession,					// [in] A connected session. See @{SessionOpen}.
																		HPMUniqueID _TaskID,				// [in] The unique identifier of the task to get the epic flag of.
																		HPMInt32 *_pData					// [out,type=bool] Pointer to a variable that will receive the epic flag. Can be 0 or 1.
																		);
...
|	Function:																						|
|																									|
|	Description:		Returns the time the task was created on.									|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}.									|
|																									|
|	Comments:			The returned object must be freed with @{ObjectFree} or a memory			|
...
\*_________________________________________________________________________________________________*/
typedef HPMError(DHPMSdkCallingConvention *HPMFunctionTaskGetOriginallyCreatedOnTime)(	void *_pSession,		// [in] A connected session. See @{SessionOpen}.
																						HPMUniqueID _TaskID,	// [in] The unique identifier of the task to get the creation time for.
																						HPMUInt64 *_pData		// [out] Pointer to a variable that will receive the time the task was created on. Expressed as number of micro seconds since 1970 UTC.
																					);
/*¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯*\
|	Function:																						|
|																									|
|	Description:		Sets the last updated user of a task.										|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}.									|
|																									|
|	See Also:			@{HPMSdkFunctions}															|
...
\*_________________________________________________________________________________________________*/
typedef HPMError(DHPMSdkCallingConvention *HPMFunctionTaskSetLastUpdatedBy)(	void *_pSession,					// [in] A connected session. See @{SessionOpen}.
																				HPMUniqueID _TaskID,				// [in] The unique identifier of the task to set the last updated time of.
																				HPMUniqueID _Data					// [in] The last user Id that updated a task to set. 
																			);
/*¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯*\
|	Function:																						|
|																									|
|	Description:		Gets the last updated user of a task.										|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}.									|
|																									|
|	See Also:			@{HPMSdkFunctions}															|
...
\*_________________________________________________________________________________________________*/
typedef HPMError(DHPMSdkCallingConvention *HPMFunctionTaskGetLastUpdatedBy)(	void *_pSession,					// [in] A connected session. See @{SessionOpen}.
																				HPMUniqueID _TaskID,				// [in] The unique identifier of the task to get the last updated time of.
																				HPMUniqueID *_pData					// [out] Pointer to a variable that will receive the last user Id that updated a task. 
																			);
