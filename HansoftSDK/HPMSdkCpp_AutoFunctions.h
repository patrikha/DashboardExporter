...
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	const NInternal_C::HPMUniqueEnum *pNativeRet = 0;
	HPMError Error = m_SDKFunctions.DashboardPageEnum(m_pSession, &pNativeRet);
	if (Error)
	{
		if (pNativeRet)
			m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
	...
	HPMUniqueEnum Ret;
	NInternal::CppConvertReverse((const NInternal_C::HPMUniqueEnum&)(*pNativeRet), Ret, CppData);
	m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
#ifdef DHansoftSDKSupportMoveSemantic
	return std::move(Ret);
#else
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
HPMString DashboardPageGetName(HPMUniqueID const &_PageID)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID PageID;
	NInternal::CppConvert(_PageID, PageID, CppData);
	const NInternal_C::HPMString *pNativeRet = 0;
	HPMError Error = m_SDKFunctions.DashboardPageGetName(m_pSession, PageID, &pNativeRet);
	if (Error)
	{
		if (pNativeRet)
			m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
void DashboardPageSetName(HPMUniqueID const &_PageID, HPMString const &_NewPageName)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID PageID;
	NInternal::CppConvert(_PageID, PageID, CppData);
	NInternal_C::HPMString NewPageName;
	NInternal::CppConvert(_NewPageName, NewPageName, CppData);
	HPMError Error = m_SDKFunctions.DashboardPageSetName(m_pSession, PageID, NewPageName.m_pString);
	if (Error)
	{
		ThrowSDKException(EHPMError(Error));
	}
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
HPMString DashboardPageGetTheme(HPMUniqueID const &_PageID)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID PageID;
	NInternal::CppConvert(_PageID, PageID, CppData);
	const NInternal_C::HPMString *pNativeRet = 0;
	HPMError Error = m_SDKFunctions.DashboardPageGetTheme(m_pSession, PageID, &pNativeRet);
	if (Error)
	{
		if (pNativeRet)
			m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
void DashboardPageSetTheme(HPMUniqueID const &_PageID, HPMString const &_NewPageTheme)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID PageID;
	NInternal::CppConvert(_PageID, PageID, CppData);
	NInternal_C::HPMString NewPageTheme;
	NInternal::CppConvert(_NewPageTheme, NewPageTheme, CppData);
	HPMError Error = m_SDKFunctions.DashboardPageSetTheme(m_pSession, PageID, NewPageTheme.m_pString);
	if (Error)
	{
		ThrowSDKException(EHPMError(Error));
	}
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
HPMDashboardThemes DashboardThemeEnum()
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	const NInternal_C::HPMDashboardThemes *pNativeRet = 0;
	HPMError Error = m_SDKFunctions.DashboardThemeEnum(m_pSession, &pNativeRet);
	if (Error)
	{
		if (pNativeRet)
			m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
	...
	HPMDashboardThemes Ret;
	NInternal::CppConvertReverse((const NInternal_C::HPMDashboardThemes&)(*pNativeRet), Ret, CppData);
	m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
#ifdef DHansoftSDKSupportMoveSemantic
	return std::move(Ret);
#else
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
HPMResourceDefinitionList DashboardPageGetSharedToWithViewingRights(HPMUniqueID const &_PageID)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID PageID;
	NInternal::CppConvert(_PageID, PageID, CppData);
	const NInternal_C::HPMResourceDefinitionList *pNativeRet = 0;
	HPMError Error = m_SDKFunctions.DashboardPageGetSharedToWithViewingRights(m_pSession, PageID, &pNativeRet);
	if (Error)
	{
		if (pNativeRet)
			m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
void DashboardPageSetSharedToWithViewingRights(HPMUniqueID const &_PageID, HPMResourceDefinitionList const &_ResourceList)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID PageID;
	NInternal::CppConvert(_PageID, PageID, CppData);
	...
	HPMError Error = m_SDKFunctions.DashboardPageSetSharedToWithViewingRights(m_pSession, PageID, &ResourceList);
	if (Error)
	{
		ThrowSDKException(EHPMError(Error));
	}
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
HPMResourceDefinitionList DashboardPageGetSharedToWithEditingRights(HPMUniqueID const &_PageID)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID PageID;
	NInternal::CppConvert(_PageID, PageID, CppData);
	const NInternal_C::HPMResourceDefinitionList *pNativeRet = 0;
	HPMError Error = m_SDKFunctions.DashboardPageGetSharedToWithEditingRights(m_pSession, PageID, &pNativeRet);
	if (Error)
	{
		if (pNativeRet)
			m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
void DashboardPageSetSharedToWithEditingRights(HPMUniqueID const &_PageID, HPMResourceDefinitionList const &_ResourceList)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID PageID;
	NInternal::CppConvert(_PageID, PageID, CppData);
	NInternal_C::HPMResourceDefinitionList ResourceList;
	NInternal::CppConvert(_ResourceList, ResourceList, CppData);
	HPMError Error = m_SDKFunctions.DashboardPageSetSharedToWithEditingRights(m_pSession, PageID, &ResourceList);
	if (Error)
	{
		ThrowSDKException(EHPMError(Error));
	}
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
void DashboardPageDelete(HPMUniqueID const &_PageID)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID PageID;
	NInternal::CppConvert(_PageID, PageID, CppData);
	HPMError Error = m_SDKFunctions.DashboardPageDelete(m_pSession, PageID);
	if (Error)
	{
		ThrowSDKException(EHPMError(Error));
	}
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
void DashboardPageCreate(HPMString const &_PageName, HPMUniqueID const &_LocalObjectID)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMString PageName;
	NInternal::CppConvert(_PageName, PageName, CppData);
	NInternal_C::HPMUniqueID LocalObjectID;
	NInternal::CppConvert(_LocalObjectID, LocalObjectID, CppData);
	HPMError Error = m_SDKFunctions.DashboardPageCreate(m_pSession, PageName.m_pString, LocalObjectID, 0);
	if (Error)
	{
		ThrowSDKException(EHPMError(Error));
	}
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
HPMUniqueID DashboardPageCreateBlock(HPMString const &_PageName, HPMUniqueID const &_LocalObjectID)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMString PageName;
	NInternal::CppConvert(_PageName, PageName, CppData);
	...
	HPMError Error = m_SDKFunctions.DashboardPageCreate(m_pSession, PageName.m_pString, LocalObjectID, &NativeRet);
	if (Error)
	{
		ThrowSDKException(EHPMError(Error));
	}
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
bool DashboardPageIsPersonal(HPMUniqueID const &_PageID)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID PageID;
	NInternal::CppConvert(_PageID, PageID, CppData);
	NInternal_C::HPMInt32 NativeRet;
	HPMError Error = m_SDKFunctions.DashboardPageIsPersonal(m_pSession, PageID, &NativeRet);
	if (Error)
	{
		ThrowSDKException(EHPMError(Error));
	}
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
HPMUniqueID DashboardPageGetCreatedBy(HPMUniqueID const &_PageID)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID PageID;
	NInternal::CppConvert(_PageID, PageID, CppData);
	NInternal_C::HPMUniqueID NativeRet;
	HPMError Error = m_SDKFunctions.DashboardPageGetCreatedBy(m_pSession, PageID, &NativeRet);
	if (Error)
	{
		ThrowSDKException(EHPMError(Error));
	}
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
HPMDashboardPageLayout DashboardPageGetLayout(HPMUniqueID const &_PageID)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID PageID;
	NInternal::CppConvert(_PageID, PageID, CppData);
	const NInternal_C::HPMDashboardPageLayout *pNativeRet = 0;
	HPMError Error = m_SDKFunctions.DashboardPageGetLayout(m_pSession, PageID, &pNativeRet);
	if (Error)
	{
		if (pNativeRet)
			m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
	...
	HPMDashboardPageLayout Ret;
	NInternal::CppConvertReverse((const NInternal_C::HPMDashboardPageLayout&)(*pNativeRet), Ret, CppData);
	m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
#ifdef DHansoftSDKSupportMoveSemantic
	return std::move(Ret);
#else
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
void DashboardPageSetLayout(HPMUniqueID const &_PageID, HPMDashboardPageLayout const &_NewPageTheme)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID PageID;
	NInternal::CppConvert(_PageID, PageID, CppData);
	NInternal_C::HPMDashboardPageLayout NewPageTheme;
	NInternal::CppConvert(_NewPageTheme, NewPageTheme, CppData);
	HPMError Error = m_SDKFunctions.DashboardPageSetLayout(m_pSession, PageID, &NewPageTheme);
	if (Error)
	{
		ThrowSDKException(EHPMError(Error), UtilGetLastErrorDescription());
	}
}

#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
HPMUniqueEnum DashboardChartEnum(HPMUniqueID const &_PageID)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID PageID;
	NInternal::CppConvert(_PageID, PageID, CppData);
	const NInternal_C::HPMUniqueEnum *pNativeRet = 0;
	HPMError Error = m_SDKFunctions.DashboardChartEnum(m_pSession, PageID, &pNativeRet);
	if (Error)
	{
		if (pNativeRet)
			m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
HPMUniqueID DashboardChartCreate(HPMUniqueID const &_PageID, HPMDashboardChartPresentationConfig const &_PresentationConfig, HPMDashboardChartComputationConfig const &_ComputationConfig, HPMUniqueID const &_LocalObjectID, HPMUniqueID const &_CloneFromChartID)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID PageID;
	NInternal::CppConvert(_PageID, PageID, CppData);
	NInternal_C::HPMDashboardChartPresentationConfig PresentationConfig;
	NInternal::CppConvert(_PresentationConfig, PresentationConfig, CppData);
	NInternal_C::HPMDashboardChartComputationConfig ComputationConfig;
	NInternal::CppConvert(_ComputationConfig, ComputationConfig, CppData);
	NInternal_C::HPMUniqueID LocalObjectID;
	NInternal::CppConvert(_LocalObjectID, LocalObjectID, CppData);
	NInternal_C::HPMUniqueID CloneFromChartID;
	NInternal::CppConvert(_CloneFromChartID, CloneFromChartID, CppData);
	NInternal_C::HPMUniqueID NativeRet;
	HPMError Error = m_SDKFunctions.DashboardChartCreate(m_pSession, PageID, &PresentationConfig, &ComputationConfig, LocalObjectID, CloneFromChartID, &NativeRet);
	if (Error)
	{
		ThrowSDKException(EHPMError(Error));
	}
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
void DashboardChartDelete(HPMUniqueID const &_ChartID)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID ChartID;
	NInternal::CppConvert(_ChartID, ChartID, CppData);
	HPMError Error = m_SDKFunctions.DashboardChartDelete(m_pSession, ChartID);
	if (Error)
	{
		ThrowSDKException(EHPMError(Error));
	}
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
void DashboardChartSetName(HPMUniqueID const &_ChartID, HPMString const &_Name)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID ChartID;
	NInternal::CppConvert(_ChartID, ChartID, CppData);
	...
	HPMError Error = m_SDKFunctions.DashboardChartSetName(m_pSession, ChartID, Name.m_pString);
	if (Error)
	{
		ThrowSDKException(EHPMError(Error));
	}
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
void DashboardChartSetPresentationConfig(HPMUniqueID const &_ChartID, HPMDashboardChartPresentationConfig const &_Config)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID ChartID;
	NInternal::CppConvert(_ChartID, ChartID, CppData);
	NInternal_C::HPMDashboardChartPresentationConfig Config;
	NInternal::CppConvert(_Config, Config, CppData);
	HPMError Error = m_SDKFunctions.DashboardChartSetPresentationConfig(m_pSession, ChartID, &Config);
	if (Error)
	{
		ThrowSDKException(EHPMError(Error));
	}
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
void DashboardChartSetComputationConfig(HPMUniqueID const &_ChartID, HPMDashboardChartComputationConfig const &_Config)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID ChartID;
	NInternal::CppConvert(_ChartID, ChartID, CppData);
	NInternal_C::HPMDashboardChartComputationConfig Config;
	NInternal::CppConvert(_Config, Config, CppData);
	HPMError Error = m_SDKFunctions.DashboardChartSetComputationConfig(m_pSession, ChartID, &Config);
	if (Error)
	{
		ThrowSDKException(EHPMError(Error));
	}
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
HPMString DashboardChartGetName(HPMUniqueID const &_ChartID)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID ChartID;
	NInternal::CppConvert(_ChartID, ChartID, CppData);
	const NInternal_C::HPMString *pNativeRet = 0;
	HPMError Error = m_SDKFunctions.DashboardChartGetName(m_pSession, ChartID, &pNativeRet);
	if (Error)
	{
		if (pNativeRet)
			m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
HPMUniqueID DashboardChartGetPageID(HPMUniqueID const &_ChartID)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID ChartID;
	NInternal::CppConvert(_ChartID, ChartID, CppData);
	NInternal_C::HPMUniqueID NativeRet;
	HPMError Error = m_SDKFunctions.DashboardChartGetPageID(m_pSession, ChartID, &NativeRet);
	if (Error)
	{
		ThrowSDKException(EHPMError(Error));
	}
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
HPMDashboardChartComputationConfig DashboardChartGetComputationConfig(HPMUniqueID const &_ChartID)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID ChartID;
	NInternal::CppConvert(_ChartID, ChartID, CppData);
	const NInternal_C::HPMDashboardChartComputationConfig *pNativeRet = 0;
	HPMError Error = m_SDKFunctions.DashboardChartGetComputationConfig(m_pSession, ChartID, &pNativeRet);
	if (Error)
	{
		if (pNativeRet)
			m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
	...
	HPMDashboardChartComputationConfig Ret;
	NInternal::CppConvertReverse((const NInternal_C::HPMDashboardChartComputationConfig&)(*pNativeRet), Ret, CppData);
	m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
#ifdef DHansoftSDKSupportMoveSemantic
	return std::move(Ret);
#else
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
HPMDashboardChartPresentationConfig DashboardChartGetPresentationConfig(HPMUniqueID const &_ChartID)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID ChartID;
	NInternal::CppConvert(_ChartID, ChartID, CppData);
	const NInternal_C::HPMDashboardChartPresentationConfig *pNativeRet = 0;
	HPMError Error = m_SDKFunctions.DashboardChartGetPresentationConfig(m_pSession, ChartID, &pNativeRet);
	if (Error)
	{
		if (pNativeRet)
			m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
	...
	HPMDashboardChartPresentationConfig Ret;
	NInternal::CppConvertReverse((const NInternal_C::HPMDashboardChartPresentationConfig&)(*pNativeRet), Ret, CppData);
	m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
#ifdef DHansoftSDKSupportMoveSemantic
	return std::move(Ret);
#else
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
HPMDashboardChartHistoricComputationConfigs DashboardChartGetHistoricComputationConfigs(HPMUniqueID const &_ChartID)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID ChartID;
	NInternal::CppConvert(_ChartID, ChartID, CppData);
	const NInternal_C::HPMDashboardChartHistoricComputationConfigs *pNativeRet = 0;
	HPMError Error = m_SDKFunctions.DashboardChartGetHistoricComputationConfigs(m_pSession, ChartID, &pNativeRet);
	if (Error)
	{
		if (pNativeRet)
			m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
	...
	HPMDashboardChartHistoricComputationConfigs Ret;
	NInternal::CppConvertReverse((const NInternal_C::HPMDashboardChartHistoricComputationConfigs&)(*pNativeRet), Ret, CppData);
	m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
#ifdef DHansoftSDKSupportMoveSemantic
	return std::move(Ret);
#else
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
HPMDashboardChartComputationConfig DashboardChartGetLastSampledHistoricComputationConfig(HPMUniqueID const &_ChartID)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID ChartID;
	NInternal::CppConvert(_ChartID, ChartID, CppData);
	const NInternal_C::HPMDashboardChartComputationConfig *pNativeRet = 0;
	HPMError Error = m_SDKFunctions.DashboardChartGetLastSampledHistoricComputationConfig(m_pSession, ChartID, &pNativeRet);
	if (Error)
	{
		if (pNativeRet)
			m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
HPMUntranslatedString DashboardUtilGetMeasureAutoName(HPMDashboardChartMeasure const &_Measure)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMDashboardChartMeasure Measure;
	NInternal::CppConvert(_Measure, Measure, CppData);
	const NInternal_C::HPMUntranslatedString *pNativeRet = 0;
	HPMError Error = m_SDKFunctions.DashboardUtilGetMeasureAutoName(m_pSession, &Measure, &pNativeRet);
	if (Error)
	{
		if (pNativeRet)
			m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
HPMUntranslatedString DashboardUtilGetFilterAutoName(HPMDashboardChartFilter const &_Filter)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMDashboardChartFilter Filter;
	NInternal::CppConvert(_Filter, Filter, CppData);
	const NInternal_C::HPMUntranslatedString *pNativeRet = 0;
	HPMError Error = m_SDKFunctions.DashboardUtilGetFilterAutoName(m_pSession, &Filter, &pNativeRet);
	if (Error)
	{
		if (pNativeRet)
			m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
bool DashboardUtilColumnCanBeUsedForDimension(HPMColumn const &_Column)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMColumn Column;
	NInternal::CppConvert(_Column, Column, CppData);
	NInternal_C::HPMInt32 NativeRet;
	HPMError Error = m_SDKFunctions.DashboardUtilColumnCanBeUsedForDimension(m_pSession, &Column, &NativeRet);
	if (Error)
	{
		ThrowSDKException(EHPMError(Error));
	}
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
bool DashboardUtilIsDimensionValidForResource(HPMDashboardChartDimension const &_Dimension, HPMUniqueID const &_ForResourceID)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMDashboardChartDimension Dimension;
	NInternal::CppConvert(_Dimension, Dimension, CppData);
	NInternal_C::HPMUniqueID ForResourceID;
	NInternal::CppConvert(_ForResourceID, ForResourceID, CppData);
	NInternal_C::HPMInt32 NativeRet;
	HPMError Error = m_SDKFunctions.DashboardUtilIsDimensionValidForResource(m_pSession, &Dimension, ForResourceID, &NativeRet);
	if (Error)
	{
		ThrowSDKException(EHPMError(Error));
	}
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
bool DashboardUtilIsMeasureValidForResource(HPMDashboardChartMeasure const &_Measure, HPMUniqueID const &_ForResourceID)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMDashboardChartMeasure Measure;
	NInternal::CppConvert(_Measure, Measure, CppData);
	...
	NInternal::CppConvert(_ForResourceID, ForResourceID, CppData);
	NInternal_C::HPMInt32 NativeRet;
	HPMError Error = m_SDKFunctions.DashboardUtilIsMeasureValidForResource(m_pSession, &Measure, ForResourceID, &NativeRet);
	if (Error)
	{
		ThrowSDKException(EHPMError(Error));
	}
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
bool DashboardUtilIsFilterValidForResource(HPMDashboardChartFilter const &_Filter, HPMUniqueID const &_ForResourceID)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMDashboardChartFilter Filter;
	NInternal::CppConvert(_Filter, Filter, CppData);
	...
	NInternal::CppConvert(_ForResourceID, ForResourceID, CppData);
	NInternal_C::HPMInt32 NativeRet;
	HPMError Error = m_SDKFunctions.DashboardUtilIsFilterValidForResource(m_pSession, &Filter, ForResourceID, &NativeRet);
	if (Error)
	{
		ThrowSDKException(EHPMError(Error));
	}
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
HPMDashboardChartValidationResult DashboardUtilIsComputationConfigValidForResource(HPMDashboardChartComputationConfig const &_Config, HPMUniqueID const &_ForResourceID)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMDashboardChartComputationConfig Config;
	NInternal::CppConvert(_Config, Config, CppData);
	NInternal_C::HPMUniqueID ForResourceID;
	NInternal::CppConvert(_ForResourceID, ForResourceID, CppData);
	const NInternal_C::HPMDashboardChartValidationResult *pNativeRet = 0;
	HPMError Error = m_SDKFunctions.DashboardUtilIsComputationConfigValidForResource(m_pSession, &Config, ForResourceID, &pNativeRet);
	if (Error)
	{
		if (pNativeRet)
			m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
	...
	HPMDashboardChartValidationResult Ret;
	NInternal::CppConvertReverse((const NInternal_C::HPMDashboardChartValidationResult&)(*pNativeRet), Ret, CppData);
	m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
#ifdef DHansoftSDKSupportMoveSemantic
	return std::move(Ret);
#else
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
HPMDashboardChartSubscription DashboardSubscribeToChart(HPMUniqueID const &_ChartID)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID ChartID;
	NInternal::CppConvert(_ChartID, ChartID, CppData);
	const NInternal_C::HPMDashboardChartSubscription *pNativeRet = 0;
	HPMError Error = m_SDKFunctions.DashboardSubscribeToChart(m_pSession, ChartID, &pNativeRet);
	if (Error)
	{
		if (pNativeRet)
			m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
	...
	HPMDashboardChartSubscription Ret;
	NInternal::CppConvertReverse((const NInternal_C::HPMDashboardChartSubscription&)(*pNativeRet), Ret, CppData);
	m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
#ifdef DHansoftSDKSupportMoveSemantic
	return std::move(Ret);
#else
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
HPMString DashboardSubscriptionGetLastResultSetAsString(HPMDashboardChartSubscription const &_Subscription)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	const NInternal_C::HPMDashboardChartSubscription *Subscription = _Subscription.GetOriginalObject();
	if (!Subscription)
	{
		ThrowSDKException(EHPMError(EHPMError_OtherError));
	}
	const NInternal_C::HPMString *pNativeRet = 0;
	HPMError Error = m_SDKFunctions.DashboardSubscriptionGetLastResultSetAsString(m_pSession, Subscription, &pNativeRet);
	if (Error)
	{
		if (pNativeRet)
			m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
HPMDashboardChartResultSet DashboardSubscriptionGetLastResultSet(HPMDashboardChartSubscription const &_Subscription)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	const NInternal_C::HPMDashboardChartSubscription *Subscription = _Subscription.GetOriginalObject();
	if (!Subscription)
	...
	const NInternal_C::HPMDashboardChartResultSet *pNativeRet = 0;
	HPMError Error = m_SDKFunctions.DashboardSubscriptionGetLastResultSet(m_pSession, Subscription, &pNativeRet);
	if (Error)
	{
		if (pNativeRet)
			m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
	...
	HPMDashboardChartResultSet Ret;
	NInternal::CppConvertReverse((const NInternal_C::HPMDashboardChartResultSet&)(*pNativeRet), Ret, CppData);
	m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
#ifdef DHansoftSDKSupportMoveSemantic
	return std::move(Ret);
#else
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
HPMUniqueID ResourceGetDashboardPage(HPMUniqueID const &_ResourceID)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID ResourceID;
	NInternal::CppConvert(_ResourceID, ResourceID, CppData);
	NInternal_C::HPMUniqueID NativeRet;
	HPMError Error = m_SDKFunctions.ResourceGetDashboardPage(m_pSession, ResourceID, &NativeRet);
	if (Error)
	{
		ThrowSDKException(EHPMError(Error));
	}
...
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID RemoteID;
	NInternal::CppConvert(_RemoteID, RemoteID, CppData);
	NInternal_C::HPMUniqueID LocalID;
	NInternal::CppConvert(_LocalID, LocalID, CppData);
	HPMError Error = m_SDKFunctions.ResourceReplaceGuestResourceWithHomeResource(m_pSession, RemoteID, LocalID);
	if (Error)
	{
		ThrowSDKException(EHPMError(Error));
	}
...
void ResourceMakeGuestResourceAHomeResource(HPMUniqueID const &_RemoteID, HPMString const &_Name, HPMString const &_NewPassword)
{
	...
	NInternal_C::HPMString NewPassword;
	NInternal::CppConvert(_NewPassword, NewPassword, CppData);
	HPMError Error = m_SDKFunctions.ResourceMakeGuestResourceAHomeResource(m_pSession, RemoteID, Name.m_pString, NewPassword.m_pString);
	if (Error)
	{
		ThrowSDKException(EHPMError(Error));
	}
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
HPMProjectCustomColumnAncestry ProjectGetCustomColumnAncestry(HPMUniqueID const &_ProjectID, HPMUInt32 _ColumnHash)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID ProjectID;
	NInternal::CppConvert(_ProjectID, ProjectID, CppData);
	NInternal_C::HPMUInt32 ColumnHash;
	NInternal::CppConvert(_ColumnHash, ColumnHash, CppData);
	const NInternal_C::HPMProjectCustomColumnAncestry *pNativeRet = 0;
	HPMError Error = m_SDKFunctions.ProjectGetCustomColumnAncestry(m_pSession, ProjectID, ColumnHash, &pNativeRet);
	if (Error)
	{
		if (pNativeRet)
			m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
	...
	HPMProjectCustomColumnAncestry Ret;
	NInternal::CppConvertReverse((const NInternal_C::HPMProjectCustomColumnAncestry&)(*pNativeRet), Ret, CppData);
	m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
#ifdef DHansoftSDKSupportMoveSemantic
	return std::move(Ret);
#else
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
void ProjectSetBugReportResources(HPMUniqueID const &_ProjectID, HPMResourceDefinitionList const &_ResourceList)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID ProjectID;
	NInternal::CppConvert(_ProjectID, ProjectID, CppData);
	NInternal_C::HPMResourceDefinitionList ResourceList;
	NInternal::CppConvert(_ResourceList, ResourceList, CppData);
	HPMError Error = m_SDKFunctions.ProjectSetBugReportResources(m_pSession, ProjectID, &ResourceList);
	if (Error)
	{
		ThrowSDKException(EHPMError(Error));
	}
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
HPMResourceDefinitionList ProjectGetBugReportResources(HPMUniqueID const &_ProjectID)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID ProjectID;
	NInternal::CppConvert(_ProjectID, ProjectID, CppData);
	const NInternal_C::HPMResourceDefinitionList *pNativeRet = 0;
	HPMError Error = m_SDKFunctions.ProjectGetBugReportResources(m_pSession, ProjectID, &pNativeRet);
	if (Error)
	{
		if (pNativeRet)
			m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
void ProjectSetDefaultQAWorkflow(HPMUniqueID const &_ProjectID, HPMUInt32 _WorkflowID)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID ProjectID;
	NInternal::CppConvert(_ProjectID, ProjectID, CppData);
	NInternal_C::HPMUInt32 WorkflowID;
	NInternal::CppConvert(_WorkflowID, WorkflowID, CppData);
	HPMError Error = m_SDKFunctions.ProjectSetDefaultQAWorkflow(m_pSession, ProjectID, WorkflowID);
	if (Error)
	{
		ThrowSDKException(EHPMError(Error));
	}
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
HPMUInt32 ProjectGetDefaultQAWorkflow(HPMUniqueID const &_ProjectID)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID ProjectID;
	NInternal::CppConvert(_ProjectID, ProjectID, CppData);
	NInternal_C::HPMUInt32 NativeRet;
	HPMError Error = m_SDKFunctions.ProjectGetDefaultQAWorkflow(m_pSession, ProjectID, &NativeRet);
	if (Error)
	{
		ThrowSDKException(EHPMError(Error));
	}
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
HPMUInt32 ProjectGetConvertedQAWorkflow(HPMUniqueID const &_ProjectID)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID ProjectID;
	NInternal::CppConvert(_ProjectID, ProjectID, CppData);
	NInternal_C::HPMUInt32 NativeRet;
	HPMError Error = m_SDKFunctions.ProjectGetConvertedQAWorkflow(m_pSession, ProjectID, &NativeRet);
	if (Error)
	{
		ThrowSDKException(EHPMError(Error));
	}
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
void TaskSetEpicFlag(HPMUniqueID const &_TaskID, bool _bData)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID TaskID;
	NInternal::CppConvert(_TaskID, TaskID, CppData);
	NInternal_C::HPMInt32 bData;
	NInternal::CppConvert(_bData, bData, CppData);
	HPMError Error = m_SDKFunctions.TaskSetEpicFlag(m_pSession, TaskID, bData);
	if (Error)
	{
		ThrowSDKException(EHPMError(Error));
	}
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
bool TaskGetEpicFlag(HPMUniqueID const &_TaskID)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID TaskID;
	NInternal::CppConvert(_TaskID, TaskID, CppData);
	NInternal_C::HPMInt32 NativeRet;
	HPMError Error = m_SDKFunctions.TaskGetEpicFlag(m_pSession, TaskID, &NativeRet);
	if (Error)
	{
		ThrowSDKException(EHPMError(Error));
	}
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
HPMUInt64 TaskGetOriginallyCreatedOnTime(HPMUniqueID const &_TaskID)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID TaskID;
	NInternal::CppConvert(_TaskID, TaskID, CppData);
	NInternal_C::HPMUInt64 NativeRet;
	HPMError Error = m_SDKFunctions.TaskGetOriginallyCreatedOnTime(m_pSession, TaskID, &NativeRet);
	if (Error)
	{
		ThrowSDKException(EHPMError(Error));
	}
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
void TaskSetLastUpdatedBy(HPMUniqueID const &_TaskID, HPMUniqueID const &_Data)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID TaskID;
	NInternal::CppConvert(_TaskID, TaskID, CppData);
	NInternal_C::HPMUniqueID Data;
	NInternal::CppConvert(_Data, Data, CppData);
	HPMError Error = m_SDKFunctions.TaskSetLastUpdatedBy(m_pSession, TaskID, Data);
	if (Error)
	{
		ThrowSDKException(EHPMError(Error));
	}
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
HPMUniqueID TaskGetLastUpdatedBy(HPMUniqueID const &_TaskID)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMUniqueID TaskID;
	NInternal::CppConvert(_TaskID, TaskID, CppData);
	NInternal_C::HPMUniqueID NativeRet;
	HPMError Error = m_SDKFunctions.TaskGetLastUpdatedBy(m_pSession, TaskID, &NativeRet);
	if (Error)
	{
		ThrowSDKException(EHPMError(Error));
	}
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
void VersionControlInit(HPMString const &_LocalPath, bool _bBlocking)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	NInternal_C::HPMString LocalPath;
	NInternal::CppConvert(_LocalPath, LocalPath, CppData);
	NInternal_C::HPMInt32 bBlocking;
	NInternal::CppConvert(_bBlocking, bBlocking, CppData);
	HPMError Error = m_SDKFunctions.VersionControlInit(m_pSession, LocalPath.m_pString, bBlocking);
	if (Error)
	{
		ThrowSDKException(EHPMError(Error));
	}
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
HPMProjectCustomColumnAncestry VariantDecode_HPMProjectCustomColumnAncestry(HPMVariantData const &_VariantData)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	const NInternal_C::HPMVariantData *VariantData = _VariantData.GetOriginalObject();
	if (!VariantData)
	...
	const NInternal_C::HPMProjectCustomColumnAncestry *pNativeRet = 0;
	HPMError Error = m_SDKFunctions.VariantDecode_HPMProjectCustomColumnAncestry(m_pSession, VariantData, &pNativeRet);
	if (Error)
	{
		if (pNativeRet)
			m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
HPMUntranslatedString VariantDecode_HPMUntranslatedString(HPMVariantData const &_VariantData)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	const NInternal_C::HPMVariantData *VariantData = _VariantData.GetOriginalObject();
	if (!VariantData)
	...
	const NInternal_C::HPMUntranslatedString *pNativeRet = 0;
	HPMError Error = m_SDKFunctions.VariantDecode_HPMUntranslatedString(m_pSession, VariantData, &pNativeRet);
	if (Error)
	{
		if (pNativeRet)
			m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
HPMBinaryBuffer VariantDecode_HPMBinaryBuffer(HPMVariantData const &_VariantData)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	const NInternal_C::HPMVariantData *VariantData = _VariantData.GetOriginalObject();
	if (!VariantData)
	...
	const NInternal_C::HPMBinaryBuffer *pNativeRet = 0;
	HPMError Error = m_SDKFunctions.VariantDecode_HPMBinaryBuffer(m_pSession, VariantData, &pNativeRet);
	if (Error)
	{
		if (pNativeRet)
			m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
	...
	HPMBinaryBuffer Ret;
	NInternal::CppConvertReverse((const NInternal_C::HPMBinaryBuffer&)(*pNativeRet), Ret, CppData);
	m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
#ifdef DHansoftSDKSupportMoveSemantic
	return std::move(Ret);
#else
...
#endif // ((!defined(DHPMSdk_OnlyDefinitions)))
#if ((!defined(DHPMSdk_OnlyDefinitions)))
HPMResourceDefinitionList VariantDecode_ProjectBugReportResources(HPMVariantData const &_VariantData)
{
	NInternal::CCppConvertContext CppData(&m_SDKFunctions, m_pSession);
	const NInternal_C::HPMVariantData *VariantData = _VariantData.GetOriginalObject();
	if (!VariantData)
	...
	const NInternal_C::HPMResourceDefinitionList *pNativeRet = 0;
	HPMError Error = m_SDKFunctions.VariantDecode_ProjectBugReportResources(m_pSession, VariantData, &pNativeRet);
	if (Error)
	{
		if (pNativeRet)
			m_SDKFunctions.ObjectFree(m_pSession, pNativeRet, nullptr);
