...
enum EHPMResourceFlag
{
	...
	EHPMResourceFlag_DashboardAccess = 1 << 9,			// The resource has access to dashboards.
	EHPMResourceFlag_DashboardCanSharePages = 1 << 10,// The resource can share dashboard pages to other users
};
...
{
	EHPMSDKSyncMethod_NewVersionOfSDKRequired,	// The resource type did not exist when this SDK was created. Upgrade to a newer version of the SDK to be able to use this type.
	EHPMSDKSyncMethod_AllMemberProjects,		// SDK session only syncs only projects that this SDK resource is a member of.
	EHPMSDKSyncMethod_AllProjects,				// SDK session only syncs all projects.
};
...
enum EHPMResourceGlobalSettingsFlag
{
	...
	EHPMResourceGlobalSettingsFlag_Theme = 1 << 20,											// Theme of the application.
};
...
typedef struct HPMResourceProperties
{
	...
	HPMUInt32 m_SDKSyncMethod;						// [type=EHPMSDKSyncMethod,default=EHPMSDKSyncMethod_AllMemberProjects] If the resource m_ResourceType is @{EHPMResourceType}_SDK this decides how the SDK session connecting with this resource sync projects. Can be one of @{EHPMSDKSyncMethod}.
	...
	HPMUniqueID m_ParentSDKID;						// If this resource is an SDK user and this resource was created for a virtual session, this is the unique database identifier of the parent SDK resource.
...
|	Function:																						|
|																									|
|	Description:		Gets the personal dashboard page for a resource.							|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}.									|
|																									|
|	See Also:			@{HPMSdkFunctions}															|
...
\*_________________________________________________________________________________________________*/
typedef HPMError(DHPMSdkCallingConvention *HPMFunctionResourceGetDashboardPage)(	void *_pSession,			// [in] A connected session. See @{SessionOpen}.
																					HPMUniqueID _ResourceID,	// [in] The unique identifier of the resource to get the personal dashboard page for.
																					HPMUniqueID *_pData			// [out] Pointer to a variable that will receive the unique identifier of the personal dahboard page.
																				);
...
|	Function:																						|
|																									|
|	Description:		Reploce remote guest share user with local user.							|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}.									|
|																									|
|	See Also:			@{HPMSdkFunctions}															|
...
\*_________________________________________________________________________________________________*/
typedef HPMError(DHPMSdkCallingConvention *HPMFunctionResourceReplaceGuestResourceWithHomeResource)(void *_pSession,		// [in] A connected session. See @{SessionOpen}.
																									HPMUniqueID _RemoteID,	// [in] The unique identifier of the remote guest share user tha will be replaced.
																									HPMUniqueID _LocalID	// [in] The unique identifier of the local user that will replace the remote user.
																									);

/*¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯*\
|	Function:																						|
|																									|
|	Description:		Make remote guest share user a local user.									|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}.									|
|																									|
|	See Also:			@{HPMSdkFunctions}															|
...
\*_________________________________________________________________________________________________*/
typedef HPMError(DHPMSdkCallingConvention *HPMFunctionResourceMakeGuestResourceAHomeResource)(	void *_pSession,				// [in] A connected session. See @{SessionOpen}.
																								HPMUniqueID _RemoteID,			// [in] The unique identifier of the remote guest share user.
