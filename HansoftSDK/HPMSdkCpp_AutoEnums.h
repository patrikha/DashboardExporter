...
enum EHPMProjectSettingsFlag
{
	...
	EHPMProjectSettingsFlag_LetResourcesChangeAgilePriorityInMyWork                      = 256,
	EHPMProjectSettingsFlag_DisplayIdealEstimateAsHours                                  = 512,
	EHPMProjectSettingsFlag_ResourcesCanImportData                                       = 1024,
};
...
enum EHPMProjectDefaultColumn
{
	...
	EHPMProjectDefaultColumn_CCCommentsTo              = 36,
...
enum EHPMFindCriteriaDataType
{
	...
	EHPMFindCriteriaDataType_DropListWithDropList    = 12,
};
