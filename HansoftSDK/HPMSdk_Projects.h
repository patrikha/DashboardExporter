...
enum EHPMProjectSettingsFlag
{
	...
	EHPMProjectSettingsFlag_LetResourcesChangeAgilePriorityInMyWork = 1 << 8,						// Resources can change sprint priority in my work. See @{EHPMTaskAgilePriorityCategory}.
	EHPMProjectSettingsFlag_DisplayIdealEstimateAsHours = 1 << 9,									// If set all ideal estimates will be displayed as hours, otherwise days.
	EHPMProjectSettingsFlag_ResourcesCanImportData = 1 << 10,										// If set resources can import data into all areas they are allowed to edit, including sections they have been delegated.
};
...
enum EHPMProjectDefaultColumn
{
	...
	EHPMProjectDefaultColumn_LastUpdatedBy,				// Last updated user column.
	...
	EHPMProjectDefaultColumn_OriginallyCreatedOnTime,	// Originally created on time column.
	EHPMProjectDefaultColumn_WorkflowEnterOnTime,		// Workflow status set on time column.
	EHPMProjectDefaultColumn_WorkflowEnterByUser,		// Workflow set by user column.
	EHPMProjectDefaultColumn_Custom,					// Custom column
	EHPMProjectDefaultColumn_IsEpic,					// Is epic column.
};
...
enum EHPMProjectField
{
	...
	EHPMProjectField_CustomColumnAncestry,					// The ancestry for a custom column
...
enum EHPMProjectWorkflowContainerFlag
{
	...
	EHPMProjectWorkflowContainerFlag_ShowInQA = 1 << 2,																	// This workflow is shown in the QA section.
	EHPMProjectWorkflowContainerFlag_ShowInPlanning = 1 << 3,															// This workflow is shown in the planning section.
};
...
|	Index:				!name																		|
\*_________________________________________________________________________________________________*/
typedef struct HPMProjectCustomColumnAncestryEntry
{
	HPMUInt32 m_Hash;			// [default=0] The hash of the column. If this custom column no longer exists you can get it with @{ProjectGetOldCustomColumn}
	HPMUInt64 m_UsedUntil;		// [default=0] The time at which this custom was renamed to another hash
} HPMProjectCustomColumnAncestryEntry;

/*¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯*\
|	Class:																							|
|																									|
|	Description:		Used for getting a custom columns ancestry in								|
|						@{ProjectGetCustomColumnAncestry},											|
|																									|
|	See Also:			@{ProjectGetCustomColumnAncestry}											|
|																									|
|	Location:			Structures																	|
|																									|
|	Index:				!name																		|
\*_________________________________________________________________________________________________*/
typedef struct HPMProjectCustomColumnAncestry
{
	HPMUInt32 m_nAncestors;										// The number of ancestors for the custom column.
	const HPMProjectCustomColumnAncestryEntry *m_pAncestors;	// Pointer to a list of ancestors for the custom column. See @{HPMProjectCustomColumnAncestryEntry}.
...
typedef HPMError (DHPMSdkCallingConvention *HPMFunctionProjectWorkflowDelete)(	void *_pSession,			// [in] A connected session. See @{SessionOpen}.
																				HPMUniqueID _ProjectID,		// [in] The unique identifier of the project to delete workflow in.
...
|	Function:																						|
|																									|
|	Description:		Gets the ancestry for a custom column in a project.							|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}.									|
|																									|
|	See Also:			@{HPMSdkFunctions}, @{HPMProjectCustomColumnAncestry}						|
|																									|
|	Location:			Function Pointers															|
|																									|
|	Index:				!name																		|
|						ProjectGetCustomColumnAncestry												|
\*_________________________________________________________________________________________________*/
typedef HPMError (DHPMSdkCallingConvention *HPMFunctionProjectGetCustomColumnAncestry)(	void *_pSession,									// [in] A connected session. See @{SessionOpen}.
																						HPMUniqueID _ProjectID,								// [in] The unique identifier of the project when the custom column exists
																						HPMUInt32 _ColumnHash,								// [in] The column hash of the column to get ancestry for
...
|	Function:																						|
|																									|
|	Description:		Sets resources that can report bugs.										|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}.									|
|																									|
|	See Also:			@{HPMSdkFunctions},															|
...
\*_________________________________________________________________________________________________*/
typedef HPMError (DHPMSdkCallingConvention *HPMFunctionProjectSetBugReportResources)(void *_pSession,								// [in] A connected session. See @{SessionOpen}.
																					HPMUniqueID _ProjectID,							// [in] The unique identifier of the QA project to set resources that can report bugs in.
																					HPMResourceDefinitionList const* _pResourceList	// [in] List of resources that can report bugs.
																					);

/*¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯*\
|	Function:																						|
|																									|
|	Description:		Gets resources that can report bugs.										|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}.									|
|																									|
|	Comments:			The returned object must be freed with @{ObjectFree} or a memory			|
...
\*_________________________________________________________________________________________________*/
typedef HPMError (DHPMSdkCallingConvention *HPMFunctionProjectGetBugReportResources)(void *_pSession,									// [in] A connected session. See @{SessionOpen}.
																					HPMUniqueID _ProjectID,								// [in] The unique identifier of the QA project to set resources that can report bugs in.
																					HPMResourceDefinitionList const** _pResourceList	// [out] List of resources that can report bugs.
																					);

/*¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯*\
|	Function:																						|
|																									|
|	Description:		Sets the default QA workflow.												|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}.									|
|																									|
|	See Also:			@{HPMSdkFunctions},															|
...
\*_________________________________________________________________________________________________*/
typedef HPMError (DHPMSdkCallingConvention *HPMFunctionProjectSetDefaultQAWorkflow)(void *_pSession,				// [in] A connected session. See @{SessionOpen}.
																					HPMUniqueID _ProjectID,			// [in] The unique identifier of the QA project to set default workflow in.
																					HPMUInt32 _WorkflowID			// [in] The unique ID of the default workflow.
																					);

/*¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯*\
|	Function:																						|
|																									|
|	Description:		Gets the default QA workflow.												|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}.									|
|																									|
|	See Also:			@{HPMSdkFunctions},															|
...
\*_________________________________________________________________________________________________*/
typedef HPMError (DHPMSdkCallingConvention *HPMFunctionProjectGetDefaultQAWorkflow)(void *_pSession,				// [in] A connected session. See @{SessionOpen}.
																					HPMUniqueID _ProjectID,			// [in] The unique identifier of the QA project to set default workflow in.
																					HPMUInt32* _WorkflowID			// [out] The unique ID of the default workflow.
																					);

/*¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯*\
|	Function:																						|
|																									|
|	Description:		Gets the old default QA workflow, i.e. the current workflow id of the QA	|
|						workflow that was used before multiple workflows could be used in the		|
|						QA section.																	|
|																									|
|																									|
|	Return Value:		Returns an error code. See @{EHPMError}.									|
...
\*_________________________________________________________________________________________________*/
typedef HPMError(DHPMSdkCallingConvention *HPMFunctionProjectGetConvertedQAWorkflow)(void *_pSession,				// [in] A connected session. See @{SessionOpen}.
																					HPMUniqueID _ProjectID,			// [in] The unique identifier of the QA project to set default workflow in.
